...
- Pageserver, Safekeeper, Compute, and Proxy: Reduced the size of database storage binaries by 50% by removing dependency debug symbols from the release build.
