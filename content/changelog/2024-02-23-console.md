...
We also added documentation for the Postgres extension [pg_prewarm](/docs/extensions/pg_prewarm), used to preload data into the shared buffer cache before it is actually needed.
