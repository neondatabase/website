...
- Neon's Business and Enterprise plans now support fixed compute sizes up to **56 vCPU**. Autoscaling is not yet supported for compute sizes larger than 16 vCPU but [reach out to us](https://console.neon.tech/app/projects?modal=support) if you'd like to extend your limit beyond that.
