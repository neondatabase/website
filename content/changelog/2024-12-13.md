...
- Neon's Business and Enterprise plans now support fixed compute sizes up to **56 CU**. Autoscaling is not yet supported for compute sizes larger than 16 CU but [reach out to us](/contact-sales) if you'd like to extend your limit beyond that.
