...
[**Building stateful AI Agents with Mastra and Lakebase Postgres**](/guides/mastra-neon) shows how to use Mastra’s Memory module with Neon so agents keep context across threads and sessions instead of starting from scratch every time.
