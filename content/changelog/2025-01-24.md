...
![Neon Chat for Visual Studio Code](/docs/changelog/neon_chat_visual_studio.png)
...
![Instagres UI](/docs/changelog/instagres.png)

Give it a try at [https://pg.new/](https://pg.new/) or by running `npx get-db` in your terminal.

**Update:** The URL was instagres.com and the CLI command was `npx instagres` at the time of this release; they are now [pg.new](https://pg.new/) and `npx get-db`.
...
![pooled connection string](/docs/changelog/connection_pooler.png)
