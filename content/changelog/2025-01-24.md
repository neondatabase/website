...
Neon's [Python SDK](https://pypi.org/project/neon-api/), which is a wrapper for the [Neon API](/docs/reference/api), has been updated to a new version (0.3.0). This new version updates the Python data types from Neon's API schema.
