...
Many clients also have native commands (for example, `/plugin marketplace add neondatabase/agent-skills` in Claude Code), and there's a curated [Neon skill pack](https://www.skills.sh/p/CjMNPtrziplKY8a2) on skills.sh.
