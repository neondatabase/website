...
Some clients have their own native command too; see the [repo](https://github.com/neondatabase/agent-skills) for per-client instructions. There's also a curated [Neon skill pack](https://www.skills.sh/p/CjMNPtrziplKY8a2) on Vercel's skills.sh.
