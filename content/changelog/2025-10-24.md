...
## Default storage quota doubled

We've doubled our default storage quota, so you can run larger databases without contacting us to raise your limit. To request a quota above the default, please [use the feedback form in console](https://console.neon.tech/app/settings?modal=feedback&modalparams=%22Storage%20limit%20increase%22).
