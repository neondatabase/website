...
This makes it easier to develop schema changes on feature branches and promote them to production. For more information, see [Neon MCP Server](/docs/ai/neon-mcp-server).
