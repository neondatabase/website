...
![Compute configurations](/docs/changelog/compute_configurations.png)
...
![Larger compute sizes](/docs/changelog/larger_compute_sizes.png)
...
![AI app banner](/docs/changelog/ai_banner.png)
...
For more, check out our new [Neon AI App Starter Kit](/docs/ai/ai-intro), where you'll find links to our starter apps, docs, and a collection of AI applications built with Neon.

Consider sharing your AI app on our **#showcase** channel on [Discord](https://discord.gg/N8kvBm7qH5). We'd love to see what you're building.
...
- Fixed an issue with the [List projects](/docs/reference/api/projects/list-projects) API that caused it to return an empty result set when including an `org_id` value.
