...
- The [Retrieve role details](/docs/reference/api/branches/get-project-branch-role) endpoint now returns an `authentication_method` field indicating how the role authenticates (`password`, `oauth`, or `no_login`).
