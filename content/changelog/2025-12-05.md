...
- **Data anonymization**
  - Added new anonymization options in the Console, including **Random Unique Email** for generating unique email addresses that satisfy uniqueness constraints.
