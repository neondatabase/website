...
Available on paid usage-based plans (Launch, Scale, Agent, Enterprise). See the [API reference](/docs/reference/api/consumption/get-consumption-history-per-branch-v2).
