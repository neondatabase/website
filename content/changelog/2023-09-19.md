...
- API: Added a [Get current user details](/docs/reference/api/users/get-current-user-info) endpoint to the Neon API for retrieving information about the current Neon user. This endpoint is still under review and subject to change in a future release.
- API: Added database and role name validation to the [Create a project](/docs/reference/api/projects/create-project) endpoint to prevent creating databases and roles with protected names.
