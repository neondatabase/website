...
- We added a `started_at` attribute to the [Retrieve compute endpoint details](/docs/reference/api/endpoints/get-project-endpoint) response. This timestamp shows when your Neon compute was last started.
