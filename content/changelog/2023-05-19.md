...
- API: Disabled `docker` as a compute provisioning option in the Neon [Create project](/docs/reference/api/projects/create-project) and [Create endpoint](/docs/reference/api/endpoints/create-project-endpoint) APIs. This option is not supported with the Neon cloud service.
