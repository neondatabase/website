...
You can also use `EXPLAIN ANALYZE` with the `FILECACHE` option to view LFC hit and miss data. 

To learn how the LFC cache hit ratio can help you right-size your compute, see [How to size your compute](/docs/manage/endpoints#how-to-size-your-compute).
