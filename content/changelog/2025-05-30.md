...
You can now enable [Neon Auth](https://neon.com/docs/guides/neon-auth) directly from the [Neon Postgres Integration on Vercel](https://vercel.com/marketplace/neon). Enable it when creating a database, or later by going to the **Storage** tab in Vercel, selecting your database, and updating the **Settings**.
...
Learn more in the [Neon Auth guide](https://neon.com/docs/guides/neon-auth).
