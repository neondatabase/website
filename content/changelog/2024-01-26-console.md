...
- Added a **Submit feedback** form to integration cards that appear on the **Integrations** page in the Neon Console, allowing users to share their experience with an integration.
- Enhanced the [IP Allow](/docs/introduction/ip-allow) user interface with some minor design and copy adjustments.
...
We're building out our Postgres extension documentation. Check out our newest guides:
