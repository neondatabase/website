...
- API: Added a `pooler_enabled` property to the [project update API call](/docs/reference/api/projects/update-project) to indicate whether or not connection pooling is enabled.
