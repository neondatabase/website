...
### New and improved Edit compute drawer

If you open the **Edit compute endpoint** drawer from a branch details page in the Neon Console (Select **Branches** -> click on a branch -> click **Edit** on the **Computes** tab), you'll notice that we've completely redesigned the drawer to provide additional information and capabilities. You'll find everything organized under the followign drop-down menus:

- **ID, Host, Compute type**
- **Usage monitoring**
