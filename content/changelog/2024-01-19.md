...
- The **Community** link in the Neon Console sidebar has been updated to direct users to the [Neon Discord](https://neon.com/discord) server, rather than the [Neon Discourse forum](https://community.neon.tech/).
