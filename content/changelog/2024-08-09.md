...
![type project name to confirm delete](/docs/changelog/confirm_delete.png)
...
<div align="center">
  <img src="/docs/changelog/autoscaling_real.png" alt="Alt text" />
...
If you're not familiar with Neon's Local File Cache (LFC), you can learn more about it here: [What is the Local File Cache?](/docs/extensions/neon#what-is-the-compute-cache)
