...
We're excited to announce that Neon on Azure is now generally available! After a successful beta period, Neon is now fully supported as an Azure Native ISV Service, allowing you to deploy and manage Neon databases directly from the Azure portal.
...
- **Microsoft Azure Consumption Commitment (MACC) eligibility** - Neon purchases made through the Azure Marketplace count toward your committed Azure spend
