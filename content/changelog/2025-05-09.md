...
- **Neon Console**
  ...
  - Fixed an issue where organization users were incorrectly shown Early Access program options in their account settings. Organization users now have a more streamlined settings experience without irrelevant Early Access options.
