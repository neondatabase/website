...
## Support for PostgreSQL Anonymizer extension (experimental)
...
The initial support includes **static masking**, which permanently replaces personal data with anonymized values. You can also automate anonymization using Neon branches and GitHub Actions. Learn more in our guide on [automating data anonymization with GitHub Actions](/docs/workflows/data-anonymization).

## ✨ New AI-friendly options in Docs

To support workflows that use AI tools, Neon Docs now includes two new options on every page:
...
These options make it easier to bring Neon documentation into your AI-assisted workflows.
