...
![Domain section on the Organization Settings page](/docs/changelog/orgs_domains_pending.png)

Colleagues who already have Neon accounts are added to the organization the next time they log in. For the full flow and behavior (roles, seat limits, multiple domains), see [Add members by domain](/docs/manage/orgs-add-members-by-domain).
