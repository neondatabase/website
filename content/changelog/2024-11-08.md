...
![account metrics widget on all projects page](/docs/changelog/paid_account_metrics_widget.png)
...
![project metrics on individual project page](/docs/changelog/paid_project_limits_widget.png)
...
- **Neon API updates**
  ...
  - [Get organization details](/docs/reference/api/organizations/get-organization)
  - [Get organization members](/docs/reference/api/organizations/get-organization-members)
  - [Get organization member details](/docs/reference/api/organizations/get-organization-member)
  - [Get organization invitation details](/docs/reference/api/organizations/get-organization-invitations)
  - [Create organizations invitations](/docs/reference/api/organizations/create-organization-invitations)
...
- **Fixes**
  ...
  - Fixed an issue with the **psql** `\help` or `\h` commands accessible via the Neon SQL Editor. The specified help page failed to display.
    ...
    To get a list of supported commands, use `\?`. For more info, see the [meta-commands](/docs/get-started/query-with-neon-sql-editor#meta-commands) section of our [Query with Neon's SQL Editor](/docs/get-started/query-with-neon-sql-editor) docs page.
    </Admonition>
