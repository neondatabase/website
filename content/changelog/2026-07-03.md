---
title: Neon CLI enhancements, Neon Object Storage in the Files SDK, and more
---

## Neon CLI enhancements

We're continually improving the Neon CLI and the developer experience around it. Recent additions include [branch-first dev loop](https://neon.com/blog/branch-first-dev-loop) (`neon link`, `neon checkout`, and `neon env pull`) commands and [`neon.ts`](/docs/reference/neon-ts). This week brings a shorter name plus two additional commands.
