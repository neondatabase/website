...
- **Neon API changes**
  ...
  We've introduced a new [Get active regions](/docs/reference/api/regions/get-active-regions) endpoint for retrieving a list of regions supported by Neon. The response body includes data such as the region ID, name, and the region's approximate geographical latitude and longitude.
