...
- **Support tickets**
  - The **Create support ticket** dialog now prompts users to allowlist `help@databricks.com` to ensure support responses don't end up in spam or junk folders. Be sure to add this address to your organization's allowlist to receive responses from our Support team.
