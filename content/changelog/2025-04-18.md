...
You can change your branch setup or compute sizes at any time, but this new project default is meant to align with typical usage scenarios, where your production branch will need more compute power (vCPU and RAM) than your less active development branches. To learn more about how to integrate branching into your workflow, read our [Database branching workflow primer](/docs/get-started-with-neon/workflow-primer).
