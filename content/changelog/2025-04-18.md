...
- **Neon API**
  ...
  - Added a new [Create auth user](https://api-docs.neon.tech/reference/createneonauthnewuser) API. This API lets users of [Neon Auth](/docs/guides/neon-auth) create new users in the `neon_auth.users_sync` table. Newly created users are automatically propagated to your auth project, whether Neon-managed or provider-owned.
