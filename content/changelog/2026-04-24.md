...
<Admonition type="note" title="Snapshot billing">
Snapshot storage is billed at $0.09/GB-month as of **May 1, 2026**. See [Backup & restore](/docs/guides/backup-restore) and [Plans](/docs/introduction/plans) for pricing details.
</Admonition>
