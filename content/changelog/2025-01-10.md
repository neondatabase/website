...
Postgres 17 is now the default for newly created Neon projects. Neon continues to support Postgres 14, 15, and 16, if you prefer to stick with those. For Neon's Postgres version support policy, see [Postgres Version Support](/docs/postgresql/postgres-version-support).
...
We’ve added an AI-powered "perplexity mode" to the [Neon Docs](/docs) site, providing a conversational interface to quickly get the answers you need.
