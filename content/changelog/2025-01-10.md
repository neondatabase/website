---
description: Postgres 17 default, new connection limits, Neon for AI Agents, and more
---

🎉 **Happy New Year, everyone!** 🎉
We're excited to kick off the year and let you know that we're shipping again! 🚢 Here's to an amazing year ahead. Let's go!

### New default Postgres version

![Create PG17 project](/docs/relnotes/create_project_17.png)

Postgres 17 is now the default for newly created Neon projects. Neon continues to support Postgres 14, 15, and 16. For our version support policy, see [Postgres Version Support](https://neon.tech/docs/postgresql/postgres-version-policy).
