...
- **Instagres (formerly Neon Launchpad)**  
  Instantly spin up a Postgres database with Instagres; no signup required. Perfect for workshops and rapid prototyping. Try it at [pg.new](https://pg.new/). **Update:** At the time of this release it was at neon.new; it's now at pg.new. To learn more, see our [Instagres docs](https://neon.com/docs/reference/instagres).
