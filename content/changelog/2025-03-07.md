...
- [Cursor & Neon Postgres MCP Server](/guides/cursor-mcp-neon)
- [Claude Desktop & Neon Postgres MCP Server](/guides/neon-mcp-server)
- [Cline & Neon Postgres MCP Server](/guides/cline-mcp-neon)
- [Windsurf & Neon Postgres MCP Server](/guides/windsurf-mcp-neon)
...
![Get started with a new Neon project](/docs/changelog/get_started_widget.png)
