...
- [Cursor & Neon MCP Server](/guides/cursor-mcp-neon)
- [Claude Desktop & Neon MCP Server](/guides/neon-mcp-server)
- [Cline & Neon MCP Server](/guides/cline-mcp-neon)
- [Windsurf & Neon MCP Server](/guides/windsurf-mcp-neon)
