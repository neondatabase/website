...
**Network transfer** (egress) is data sent from your Neon databases to clients. It's one of the usage metrics that affects your bill on paid plans, and many teams only notice it when it shows up as a line item. We want to make it easier to understand and stay on top of it.
