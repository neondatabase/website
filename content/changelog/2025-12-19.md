...
- Added an [Encore framework integration guide](/docs/guides/encore) showing how to build backend applications with automatic infrastructure provisioning and Lakebase Postgres.
