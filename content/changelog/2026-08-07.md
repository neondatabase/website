...
Browse the full catalog in the [model reference](/docs/ai-gateway/models#available-models), where you can filter by provider or open weights and open any model for a copy-paste quickstart. To see what your own project can reach right now, call [`GET /v1/models`](/docs/ai-gateway/models#list-available-models).
