...
neon profiles create ci --mint --project-id green-breeze-12345678   # or hold a scoped key, no browser
```
...
See the [`neon profiles` reference](/docs/cli/profiles) for the full command set and for how `--profile` resolves against `NEON_API_KEY`.
