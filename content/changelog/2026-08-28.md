...
Our [Postgres version support policy](/docs/postgresql/postgres-version-support#recent-minor-version-rollouts) docs now include a rollout history for recent minor releases. For each release, you can see the date PostgreSQL published it, the versions it included, when it became available on Neon, and how long that took. For example:
