...
**Update:** At the time of this release, the URL was pg.new, the CLI was `npx neondb`, and the Vite plugin was `@neondatabase/vite-plugin-postgres`; they are now neon.new, `npx neon-new`, and `vite-plugin-neon-new`.
