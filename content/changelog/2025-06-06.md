...
Get started immediately by visiting [pg.new](https://pg.new) in your browser, running `npx neondb` from the command line, or integrating automatic database provisioning into Vite projects with `@neondatabase/vite-plugin-postgres`.

**Update:** At the time of this release it was at neon.new; it's now at pg.new.
