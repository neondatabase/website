...
- We've added new API endpoints to help you manage your Neon Auth domains: [list domains](/docs/reference/api/auth-legacy/list-neon-auth-redirect-uri-whitelist-domains), [add a domain](/docs/reference/api/auth-legacy/add-neon-auth-domain-to-redirect-uri-whitelist), and [delete a domain](/docs/reference/api/auth-legacy/delete-neon-auth-domain-from-redirect-uri-whitelist). These endpoints make it easy to manage your redirect URIs programmatically.
