...
[SST](https://sst.dev/), an open-source framework for building full-stack applications on your own infrastructure, now supports Neon through the Pulumi provider. Define your Neon databases in your `sst.config.ts` and connect them to your serverless applications, getting automated database provisioning alongside your application deployments on AWS. To learn how, see [Manage Neon with SST](/guides/neon-sst).
