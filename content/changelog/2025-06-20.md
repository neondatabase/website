...
- **Streamlined Neon Auth setup**
  ...
  Neon Auth brings authentication and user management natively to your Neon Postgres database. To try it out, refer to opur setup guides for Next.js, React, and JavaScript. You can find them [here](/docs/neon-auth/overview).
