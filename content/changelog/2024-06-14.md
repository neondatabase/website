...
- Schema-diff in [Neon CLI commands — branches](/docs/cli/branches#schema-diff)
...
- The Neon CLI now supports a `--no-color` [global option](/docs/cli#global-options), which you can use to decolorize CLI command output when using Neon CLI commands in your CI/CD pipelines.
