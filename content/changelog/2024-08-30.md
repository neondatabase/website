...
- Fixed an issued with the Neon CLI's `neonctl -v` command. The commands returned `unknown` instead of the CLI version. Thanks to our community member [@mrl5](https://github.com/mrl5) for the contribution.
