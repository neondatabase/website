...
The [Neon VS Code Extension](/docs/local/vscode-extension) now features enhanced database management capabilities and improved connection string workflows. The extension makes it easy to manage and copy direct connection strings for your branches, so you can quickly integrate them into your applications.
...
> **Note for existing users:** The extension no longer includes local proxy functionality. Instead, it simplifies working with direct branch connection strings.
