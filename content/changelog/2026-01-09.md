...
The Neon VS Code Extension offers a full-featured database development experience directly in your IDE. Evolved from our previous Neon Local extension, it now includes enhanced database management capabilities. Connect to any Neon branch using a static localhost connection string, browse your database schema with an intuitive tree view, and write and execute SQL queries with syntax highlighting and results display. You can create, switch, or reset branches, manage ephemeral branches with automatic cleanup, and edit table data with a spreadsheet-like interface—all without leaving your editor. Available for VS Code, Cursor, Windsurf, and other compatible editors. [Get started with the Neon VS Code Extension](/docs/local/vscode-extension).
