...
- Fixed an issue where usage limits for Neon projects created using [Instagres](https://pg.new/) were not reset after being claimed to a Neon account. **Update:** At the time of this release it was at neon.new; it's now at pg.new.
