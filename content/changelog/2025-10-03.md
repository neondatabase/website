...
- **New claim command**: We added a `neondb claim` command that lets you claim databases directly from the CLI. This command looks for a `PUBLIC_LAUNCHPAD_CLAIM_URL` by default.
