...
## Building a knowledge base Lakebase Search

Last week we annouoced [Lakebase Search](/docs/ai/lakebase-search), which supports vector and BM25 full-text search through two new Postgres extensions. This week, we've published a new guide that walks through [building a knowledge base with vector and BM25 search](/guides/lakebase-vector-bm25-search) using Next.js, `lakebase_vector`, and `lakebase_text`.

To try Lakebase Search, sign up for private preview access below.
