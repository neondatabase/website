...
Neon has a new [Python SDK](https://pypi.org/project/neon-api/), which is a wrapper for the [Neon API](/docs/reference/api). This SDK simplifies integration of Python applications with Neon by providing methods to programmatically manage Neon API keys, projects, branches, databases, endpoints, roles, and operations.
...
In addition to the new Python SDK, Neon offers a TypeScript SDK for the Neon API. [Learn more](/docs/reference/sdk).
</Admonition>
...
![Import Data Assistant interface](/docs/changelog/migration_assistant.png)
...
- **Neon API updates**
  ...
  - [Update the role for an organization member](/docs/reference/api/organizations/update-organization-member)
  - [Remove member from the organization](/docs/reference/api/organizations/remove-organization-member)
