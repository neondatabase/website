...
Our **Vercel Previews** and our **GitHub** integrations are now supported on Organization accounts. In case you're not familiar:
...
- The [GitHub Integration](/docs/guides/neon-github-integration) connects your Neon projects to corresponding GitHub repositories, which lets you add your database to your developer workflow.
