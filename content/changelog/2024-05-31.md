...
- Custom-built Postgres extension support is now an Enterprise plan feature only. Any custom-built extensions that we currently support not affected by this change and will remain supported regardless of your plan.
