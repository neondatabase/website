...
- The [Get projects](https://api-docs.neon.tech/reference/listprojects) API now includes a `search` parameter that lets you to search for projects by the project name or id.
...
Did you know Neon has a [YouTube channel](https://www.youtube.com/@neondatabase)? Be sure to check out our latest videos:
