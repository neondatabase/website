...
![Streamlined Neon Auth setup](/docs/changelog/neon_auth_splash.png)
...
- Updated the [Delete VPC endpoint](/docs/reference/api/organizations/delete-organization-vpc-endpoint) API to clarify that deleted VPC endpoints cannot be re-added to the same Neon organization.
