...
https://neon.com/docs/workflows/data-anonymization#api-referencevalid

> If you've previously subscribed to the Neon Status page via RSS, you'll need to update your feed. For instructons, see [Neon status](/docs/introduction/status).
