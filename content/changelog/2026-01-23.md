---
title: Agent Skills, Data API provisioning, and faster docs
---
...
<CompactCards cols={4} withToggler>
...
- Added support for configuring the Neon MCP Server in read-only mode. You can now restrict the MCP Server to read-only tools and read-only SQL transactions directly from the VS Code extension settings. See [Neon VS Code Extension](/docs/local/vscode-extension).
