...
Install our [Agent Skills](https://github.com/neondatabase/agent-skills) to teach your AI coding assistant about Neon best practices, connection methods, ORM setup, and branching workflows. Works across Claude Code, Cursor, VS Code, and Windsurf.
...
We've added quick actions to the [Neon documentation homepage](/docs/introduction). Everything you need to go from docs to working code is now just a click away.
