...
We've removed the $5 minimum from our paid plans. Neon is now purely usage-based: you only pay for what you actually use, and bills under $0.50 are waived entirely.

This makes it easier to start small and scale as you grow. If you're on the Free plan and considering an upgrade, there's no minimum commitment to worry about. You can access paid features like more storage and compute, and only pay for the resources you consume.
