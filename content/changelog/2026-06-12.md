---
title: Lakebase Search, command bar, neon.ts config as code, and more
---
...
Available in **neonctl v2.24.0**. See [`neonctl config`](/docs/cli/config) for the full command reference and the [neon.ts reference](/docs/cli/neon-ts) for the file format.
