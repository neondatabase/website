...
- Updated the [Vercel](/docs/guides/vercel-overview) guide to include the following topics:
  - [Add the Neon Vercel Integration to another Vercel project](/docs/guides/vercel-overview)
  - [Use the Neon integration](/docs/guides/vercel-overview)
...
- Added descriptions for `Operation`, `Project`, `Branch`, and `Endpoint` properties to the [Neon API Reference](/docs/reference/api).
