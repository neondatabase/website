...
We've updated our [pgvector](/docs/extensions/pgvector) extension for vector similarity search in Postgres to version 0.7.0. This new version of `pgvector` adds the following features and enhancements:
