...
Along with GA for Organizations, we're also announcing support for [Organizations](https://neon.tech/docs/manage/organizations). As an admin of an organization, you control your organization's API keys. These keys provide admin-level access to all organization resources, including projects, members, and billing information. See [Organization API keys](/docs/manage/orgs-api).
