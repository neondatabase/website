...
- UI: Updated the Neon Free Tier limits. See [Technical Preview Free Tier](../../introduction/introduction/technical-preview-free-tier/) for details.
- UI: Added a **Delete endpoint** button to the **Endpoints** page.
- UI: Updated the Neon [passwordless connect](../../connect/passwordless-connect) feature to select an endpoint to connect to instead of a project.
...
- UI: Stopped polling when deleting a project, which was not necessary.
