...
- Control Plane: Fixed a [passwordless auth](../connect/passwordless-connect) issue that occurred when creating a new project using the project selection interface.
