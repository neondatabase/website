...
**History retention and point-in-time restore**
 ...
 [Neon Pro plan](/docs/introduction/pro-plan) users can now configure the history retention period for a Neon project. By default, Neon retains a 7-day history of changes for all branches. This feature enables point-in-time restore, allowing you to restore data to any point in time within the defined period. [Neon Pro plan](/docs/introduction/pro-plan) users can retain up to 30 days of history. The **History retention** setting is located in the Neon Console under **Settings** > **Storage**. For more information, see [Branching — Point-in-time restore](https://neon.tech/docs/guides/branching-pitr).
