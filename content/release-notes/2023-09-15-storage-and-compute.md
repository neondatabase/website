...
Neon Free Tier users, who are limited to a single Neon project, can migrate data to Postgres 16 by dumping data locally, removing the existing Neon project, creating a new Neon project with Postgres 16, and restoring data to the new Neon project. For data migration instructions, see [Import data from Postgres](/docs/import/import-from-postgres).
