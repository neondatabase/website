...
- Added tabs for providing multiple code snippet examples per language or framework
- Added **Connection string** and **Parameters only** code snippets
- Fixed Java script code snippet highlighting
- The reveal secrets icon is now hidden if the snippet has no password
