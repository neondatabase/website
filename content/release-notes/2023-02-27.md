...
- Updated the [Vercel](/docs/guides/vercel) guide to include the following topics:
  - [Adding the Neon Vercel integration to another Vercel project](/docs/guides/vercel#add-the-integration-to-another-vercel-project).
  - [Using the Neon integration](/docs/guides/vercel#use-the-neon-vercel-integration).
  - [Connecting Vercel and Neon manually](https://neon.tech/docs/guides/vercel-manual).
