...
- To minimize storage consumption during data replication to Neon, reduce your [history window](/docs/introduction/history-window) setting. For example, set it to 1 hour or 0 during the initial copy, and restore it to the desired value afterward.
