...
updatedOn: '2025-07-03T12:36:49.558Z'
---
...
```bash
# Branch 1
postgresql://database_name_owner:AbC123dEf@ep-shiny-cell-a5y2zuu0.c-2.us-east-2.aws.neon.tech/dbname?sslmode=require&channel_binding=require

# Branch 2
postgresql://database_name_owner:AbC123dEf@ep-hidden-hall-a5x58cuv.c-2.us-east-2.aws.neon.tech/dbname?sslmode=require&channel_binding=require
```
