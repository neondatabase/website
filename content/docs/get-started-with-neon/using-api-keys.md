...
Once authenticated, a user can create and access [Projects](../cloud/concepts/#project) and [query Project data](../tutorials#query-via-ui). You can also manage [Postgres Users](../cloud/concepts/#postgres-users) and [Databases](../cloud/concepts/#postgres-databases) in each Project.
