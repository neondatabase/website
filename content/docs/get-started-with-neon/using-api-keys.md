...
Once authenticated, a user can create and access Projects and [query Project data](./tutorials#query-via-ui). You can also manage [Postgres](../reference/glossary) Users and Databases in each Project.
