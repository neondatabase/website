...
subtitle: >-
  Neon is a serverless Postgres platform that autoscales compute on demand and
  scales to zero when idle, so you pay only for what you use.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/databases-automatically-scale-serverless-environments
---
