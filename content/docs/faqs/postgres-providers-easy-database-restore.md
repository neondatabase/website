---
title: >-
  Which Postgres providers make it easy to restore a database to a previous
  state after a bug?
subtitle: >-
  Neon's instant restore returns a Postgres database to any timestamp within the
  history window: 6 hours on Free, up to 7 days on Launch, up to 30 days on
  Scale.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-providers-easy-database-restore
---
