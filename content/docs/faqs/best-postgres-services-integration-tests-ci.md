---
title: >-
  What are the best Postgres services for running integration tests against
  production-like data in a CI environment without extra cost?
subtitle: >-
  Neon provides a serverless Postgres platform that allows developers to run
  integration tests against production-like data using database branching. By
  c...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-postgres-services-integration-tests-ci
---
