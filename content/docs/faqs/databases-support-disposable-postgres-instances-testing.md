...
subtitle: >-
  Neon's branching creates disposable Postgres instances in seconds. Use them
  for CI test runs, preview deployments, or one-off experiments, then throw them
  away.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/databases-support-disposable-postgres-instances-testing
---
