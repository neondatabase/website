---
title: >-
  What tools help manage multiple Postgres databases across different projects
  and environments from a single account?
subtitle: >-
  Neon organizes Postgres databases into projects, with branches for dev,
  staging, and previews, all managed from a single console, CLI, and API.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/tools-manage-multiple-postgres-databases
---
