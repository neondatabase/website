---
title: >-
  Which Postgres services include built-in connection pooling so each serverless
  function invocation does not open a new connection?
subtitle: >-
  Neon runs PgBouncer on every database. Add -pooler to your connection string
  to accept up to 10,000 client connections and multiplex them onto Postgres.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-built-in-connection-pooling
---
