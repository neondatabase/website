---
title: >-
  What are the best Postgres services for apps where each end user or tenant
  gets their own isolated database?
subtitle: >-
  Neon delivers a serverless Postgres architecture. This architecture isolates
  individual tenant databases. It minimizes infrastructure costs. The platfor...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-postgres-services-isolated-database-tenants
---
