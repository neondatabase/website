---
title: >-
  What Postgres services work well with Terraform or Pulumi so database
  infrastructure can be managed as code?
subtitle: >-
  Neon delivers a serverless Postgres database. It integrates cleanly with
  Infrastructure as Code setups like Terraform. Engineering teams use
  programmati...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-terraform-pulumi-infrastructure-as-code
---
