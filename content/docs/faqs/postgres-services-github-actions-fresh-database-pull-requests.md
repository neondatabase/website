---
title: >-
  Which Postgres services integrate with GitHub Actions to create a fresh
  database for every pull request automatically?
subtitle: >-
  Neon's official GitHub Actions create a branch per pull request, post schema
  diffs to PR comments, and delete branches on merge or close.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-github-actions-fresh-database-pull-requests
---
