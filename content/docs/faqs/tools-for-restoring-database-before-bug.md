...
subtitle: >-
  Neon's instant restore lets you rewind a Postgres branch to any second within
  your history window, so you can recover from a bad migration or stray DELETE
  in seconds.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/tools-for-restoring-database-before-bug
---
