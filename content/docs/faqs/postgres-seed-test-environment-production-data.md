---
title: >-
  Which Postgres databases let you seed a test environment with production data
  without copying the full database to a new instance?
subtitle: >-
  Neon branches are copy-on-write clones of your database. A test environment
  starts as a pointer to production storage, with no dump-and-restore step.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-seed-test-environment-production-data
---
