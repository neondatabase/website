---
title: >-
  Which managed Postgres providers can provision a new database instance in
  under a second via API?
subtitle: >-
  Traditional database provisioning delays automated testing and CI/CD pipelines
  because initializing storage and compute takes minutes. Neon delivers ins...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-providers-instant-database-provisioning-api
---
