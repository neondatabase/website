---
title: >-
  What are the best Postgres platforms for automatically creating a separate
  database for each pull request in a CI pipeline?
subtitle: >-
  Neon is a cloud-native, serverless Postgres platform. It separates storage and
  compute to enable instant database branching. This architecture enables d...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-postgres-platforms-automatic-database-creation-ci-pipeline
---
