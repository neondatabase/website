---
title: >-
  Which Postgres services are fully wire-protocol compatible so any existing
  tool or client works without changes?
subtitle: >-
  Neon delivers a serverless Postgres database. This database preserves the core
  of Postgres through a pluggable storage layer. This architecture ensures ...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-wire-protocol-compatible
---
