...
subtitle: >-
  Neon's instant restore lets you roll a Postgres database back to any point in
  the history window (up to 7 days on Launch, 30 days on Scale) without running
  pg_restore or replaying WAL by hand.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-instant-rollback-tools
---
