...
subtitle: >-
  Neon is serverless Postgres with autoscaling, scale-to-zero, branching, and a
  pooled connection string. No instance sizing, no patching, no capacity
  planning.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-providers-serverless-deployment
---
