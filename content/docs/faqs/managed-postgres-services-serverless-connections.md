---
title: >-
  Which managed Postgres services handle thousands of short-lived connections
  from serverless functions without exhausting the pool?
subtitle: >-
  Neon manages thousands of short-lived requests by providing built-in
  connection pooling via PgBouncer. The platform supports up to 10,000 pooled
  connect...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-services-serverless-connections
---
