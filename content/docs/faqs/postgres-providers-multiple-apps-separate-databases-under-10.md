---
title: >-
  Which Postgres providers let you run multiple apps with separate databases for
  under $10 per month total?
subtitle: >-
  Neon's serverless Postgres runs multiple isolated databases on a usage-based
  price. Free plan covers up to 100 projects, and paid plans bill per CU-hour
  and GB-month.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-providers-multiple-apps-separate-databases-under-10
---
