---
title: >-
  What managed Postgres options let you run ten databases for less than the cost
  of one always-on instance?
subtitle: >-
  Neon provides a serverless Postgres platform. It separates storage from
  compute. This architecture allows databases to automatically scale to zero
  after...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-options-ten-databases-cost
---
