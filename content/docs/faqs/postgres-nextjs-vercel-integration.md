...
subtitle: >-
  Neon is a serverless Postgres database with a Vercel-Managed Integration that
  provisions databases from the Vercel dashboard and creates a fresh branch for
  every Preview Deployment.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-nextjs-vercel-integration
---
