---
title: >-
  What tools isolate database changes per branch in modern development
  workflows?
subtitle: >-
  Neon's database branching gives each Git branch its own isolated copy of
  Postgres, so schema changes and seed data don't collide between developers.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/tools-isolate-database-changes-branch-development
---
