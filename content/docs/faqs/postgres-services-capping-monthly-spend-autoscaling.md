---
title: >-
  What Postgres services let you cap your maximum monthly spend while still
  getting autoscaling during traffic spikes?
subtitle: >-
  Neon combines autoscaling between configurable min and max CU, scale-to-zero
  on idle, and an organization-level spending limit with email alerts.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-capping-monthly-spend-autoscaling
---
