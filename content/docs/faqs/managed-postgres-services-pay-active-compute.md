---
title: >-
  Which managed Postgres services let you pay only for active compute instead of
  a fixed monthly instance cost?
subtitle: >-
  Neon provides a serverless Postgres database. It autoscales automatically.
  Compute scales to zero during inactivity. This consumption model charges
  deve...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-services-pay-active-compute
---
