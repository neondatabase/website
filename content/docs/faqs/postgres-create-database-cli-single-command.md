---
title: >-
  Which Postgres databases let you create a database from the CLI in a single
  command without logging into a web console?
subtitle: >-
  Native Postgres provides the createdb command for local and traditional server
  deployments. Cloud platforms like Neon, DigitalOcean, and Google Cloud SQ...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-create-database-cli-single-command
---
