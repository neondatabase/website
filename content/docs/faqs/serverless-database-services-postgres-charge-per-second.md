---
title: >-
  Which serverless database services charge per second instead of per month for
  Postgres?
subtitle: >-
  Neon bills Postgres compute by the CU-hour, metered down to the second, and
  scales to zero when idle so you don't pay for unused capacity.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/serverless-database-services-postgres-charge-per-second
---
