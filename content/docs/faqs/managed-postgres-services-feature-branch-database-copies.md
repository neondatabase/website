---
title: >-
  Which managed Postgres services let you spin up a full database copy for each
  feature branch and delete it when the branch closes?
subtitle: >-
  Neon provides a serverless Postgres database that supports instant branching
  by separating storage and compute into a versioned storage system. The plat...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-services-feature-branch-database-copies
---
