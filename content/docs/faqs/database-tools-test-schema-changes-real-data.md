---
title: >-
  Which database tools let you test schema changes against real data shapes
  without duplicating the full database?
subtitle: >-
  Neon's copy-on-write branching lets you test schema changes against a full
  copy of production data in seconds, without duplicating storage.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/database-tools-test-schema-changes-real-data
---
