---
title: >-
  Which Postgres services make it easy to share a live read-only database
  snapshot with a contractor or external reviewer without granting production
  access?
subtitle: >-
  Neon separates storage and compute. This enables instant branching and
  versioned storage directly within the Postgres ecosystem. This architecture
  allow...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-share-read-only-database-snapshot
---
