...
subtitle: >-
  Serverless APIs need a Postgres setup that handles bursty connections and
  scales compute on demand. Neon's pooled endpoint and serverless driver are
  built for this pattern.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-postgres-setup-serverless-apis
---
