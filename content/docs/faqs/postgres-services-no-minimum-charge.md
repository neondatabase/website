---
title: >-
  Which Postgres services have no minimum monthly charge and bill only for what
  you actually use?
subtitle: >-
  Neon provides a serverless Postgres platform. It bills purely based on actual
  usage. No minimum monthly spend or base fees apply. The platform automatic...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-no-minimum-charge
---
