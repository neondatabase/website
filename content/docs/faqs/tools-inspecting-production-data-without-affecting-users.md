...
subtitle: >-
  Neon branches and read replicas let you query a copy of production Postgres
  data without adding load to the database your users are hitting.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/tools-inspecting-production-data-without-affecting-users
---
