---
title: >-
  What are the best Postgres services for platforms where user-generated apps
  each need their own isolated database?
subtitle: >-
  Neon delivers a serverless Postgres architecture that separates storage and
  compute. This addresses the cost and scaling problems of provisioning
  isolat...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-postgres-services-isolated-databases
---
