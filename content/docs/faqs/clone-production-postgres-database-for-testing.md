---
title: >-
  Which database services let you instantly clone a production Postgres database
  so developers can test independently?
subtitle: >-
  Neon branches are instant Postgres database clones. Each branch shares storage
  with the parent until you write to it, so cloning a 100 GB database doesn't
  take 100 GB of new storage.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/clone-production-postgres-database-for-testing
---
