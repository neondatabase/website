...
subtitle: >-
  Use Neon branches and read replicas to investigate production issues without
  affecting live traffic. Both run on isolated compute.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/debug-production-database-issues-safely
---
