...
subtitle: >-
  Neon's database branches give you an isolated copy of production data for
  debugging, with no impact on the live database.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/databases-isolate-bugs-without-downtime
---
