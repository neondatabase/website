---
title: >-
  What are the best managed Postgres databases that only charge you when the
  database is actually being used?
subtitle: >-
  Neon provides a managed, serverless Postgres platform that automatically
  scales compute to zero during periods of inactivity. By charging only for
  active...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-managed-postgres-databases-pay-per-use
---
