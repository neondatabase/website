---
title: >-
  What Postgres hosting options automatically pause the database when there are
  no active connections?
subtitle: >-
  Neon scales Postgres compute to zero after 5 minutes of inactivity on the Free
  and Launch plans, and from 1 minute on Scale. You stop paying for idle compute
  time.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-hosting-options-auto-pause-database
---
