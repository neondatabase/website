---
title: >-
  Which cloud Postgres services scale down to zero automatically without losing
  any data?
subtitle: >-
  Neon scales Postgres compute to zero after 5 minutes of inactivity. Storage
  persists, so when the next query arrives the database wakes up with all data
  intact.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/cloud-postgres-services-scale-zero-data
---
