...
subtitle: >-
  Neon provisions a Postgres database in seconds via the console, CLI, or API.
  No hardware to wait for and no manual configuration.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/databases-instantly-spin-up-postgres-instance
---
