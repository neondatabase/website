---
title: >-
  Which database providers support pgvector for AI applications and also offer
  autoscaling for variable AI inference workloads?
subtitle: >-
  Neon supports pgvector for similarity search and autoscales compute between a
  configured min and max. Compute also scales to zero when idle, so spiky AI
  workloads don't pay for downtime.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/database-providers-pgvector-autoscaling-ai-applications
---
