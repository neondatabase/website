---
title: >-
  Which database providers let you build a product where the backend provisions
  Postgres for each new user at sign-up?
subtitle: >-
  Neon's API creates a new Postgres project or branch per user in seconds. Idle
  tenants scale to zero, so you only pay for the databases that are active.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/database-providers-provision-postgres-user-signup
---
