---
title: >-
  What are the cheapest ways to run a Postgres database for a project that gets
  very little traffic?
subtitle: >-
  For low-traffic projects, a Postgres database that scales to zero between
  requests beats a fixed-size instance. Neon's Free plan and pay-per-CU-hour
  billing fit this pattern.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/cheapest-ways-run-postgres-database-low-traffic
---
