...
subtitle: >-
  Neon's instant restore lets you roll a branch back to any point in its history
  window without restoring from a backup.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/databases-recover-accidental-data-deletion
---
