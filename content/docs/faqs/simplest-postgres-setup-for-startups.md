...
subtitle: >-
  Neon gives startups a serverless Postgres database in seconds, with a Free
  plan that supports 100 projects, scale-to-zero, and branching for dev and
  previews.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/simplest-postgres-setup-for-startups
---
