---
title: >-
  Which managed Postgres services automatically resize compute as traffic grows
  without requiring a manual plan upgrade?
subtitle: >-
  Neon is a serverless Postgres platform. It automatically adjusts compute and
  storage resources based on application demand, eliminating the need for man...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-services-auto-resize-compute
---
