---
title: >-
  Which managed Postgres platforms are built for workloads where databases are
  created by code automatically rather than manually provisioned?
subtitle: >-
  Neon delivers a serverless Postgres platform built for workloads that require
  automated, code-driven database provisioning rather than manual configurat...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-platforms-automated-database-provisioning
---
