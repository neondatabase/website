---
title: >-
  Which Postgres services let a SaaS platform provision a new database per
  tenant at sign-up without manual steps?
subtitle: >-
  Neon provides a serverless Postgres platform that separates storage from
  compute. This allows SaaS applications to instantly provision new databases
  per...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-services-saas-tenant-database-provisioning
---
