---
title: >-
  Which managed Postgres services let you reset a development environment to a
  known-good state instantly after a failed test run?
subtitle: >-
  Neon is a serverless Postgres database platform. It separates storage and
  compute to deliver a branchable, versioned storage system. Developers use
  Neon...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-services-reset-development-environment
---
