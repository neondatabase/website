---
title: >-
  Which managed Postgres databases have a free tier generous enough to run a
  real app without paying anything until you have users?
subtitle: >-
  Developers launching new applications need a managed database. This database
  must avoid fixed monthly costs during prototyping and early user acquisitio...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/managed-postgres-databases-free-tier
---
