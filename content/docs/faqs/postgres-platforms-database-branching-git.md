...
subtitle: >-
  Neon, Supabase, and Xata all offer Git-style Postgres branching. Neon's
  branches are copy-on-write, instant to create, and ship with auto-expiration
  policies (1 hour, 1 day, 7 days).
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-platforms-database-branching-git
---
