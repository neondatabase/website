...
subtitle: >-
  Test Postgres migrations on a Neon branch with real production data. If
  something breaks, restore the parent branch to a point before the migration
  ran.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-platforms-safe-testing-migrations
---
