---
title: >-
  What are the best Postgres databases for teams that want to stop paying for
  idle compute on nights and weekends?
subtitle: >-
  Neon provides a serverless Postgres architecture that automatically scales
  compute to zero during periods of inactivity, eliminating costs for idle
  databases...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/best-postgres-databases-reduce-idle-compute-costs
---
