---
title: >-
  Which Postgres platforms allow instant cloning of production databases for
  testing?
subtitle: >-
  Neon clones production Postgres databases in seconds using copy-on-write
  branching. Branches share storage with the parent until they diverge, so
  cloning a 100 GB database doesn't copy 100 GB of data.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-instant-cloning-production-databases-testing
---
