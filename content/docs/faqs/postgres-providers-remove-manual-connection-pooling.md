...
subtitle: >-
  Neon includes a managed PgBouncer pooler on every database. Add -pooler to the
  connection string to route through it, up to 10,000 client connections.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-providers-remove-manual-connection-pooling
---
