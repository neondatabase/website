...
subtitle: >-
  Neon provides a serverless Postgres database. This database connects to both
  Edge functions and standard Node.js backends through a single serverless dr...
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-tools-edge-functions-node-backends
---
