...
subtitle: >-
  Neon pairs a managed PgBouncer pooler (up to 10,000 client connections) with a
  serverless driver that queries over HTTP or WebSockets, avoiding TCP setup per
  invocation.
enableTableOfContents: true
isDraft: false
redirectFrom:
  - /faqs/postgres-serverless-functions-connection-issues
---
