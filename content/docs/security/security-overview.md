...
- **IP Allow** — For additional connection security, the Neon Business plan offers [IP allowlist support](#ip-allowlist-support), which lets you to limit access to trusted IPs.
