...
You can verify that your connection to Neon uses SSL/TLS using when connection via `psql`. The connection response shows the connection protocol (TLSv1.3) and the encryption cipher.

Connect to your Neon database with `psql`:
