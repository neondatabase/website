...
## Excluded Neon features under HIPAA

Neon’s **Data API** feature is hosted outside of Neon’s HIPAA-compliant infrastructure and should not be used with HIPAA-enabled Neon projects.
