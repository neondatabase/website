...
A string containing details for connecting to a Neon project branch. The details include a user name, compute endpoint hostname, and database name; for example:
