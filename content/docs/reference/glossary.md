...
<a id="connection-string">Connection String</a>
...
Log Sequence Number. A byte offset to a location in the [WAL stream]((/docs/reference/glossary/#wal-stream)).
...
The ability to authenticate without providing a password. Neon’s [Quick auth](/docs/reference/glossary/#quick-auth) feature supports passwordless authentication.  
