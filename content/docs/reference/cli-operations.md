...
Ensure that you have [installed the Neon CLI](../reference/neon-cli/get-started). Once you have done that, you can use the `operations` command to view project operations from the command line.
