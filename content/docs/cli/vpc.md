...
summary: >-
  The Neon CLI `neon vpc` command controls Private Networking by
...
### neon vpc endpoint list (#endpoint-list)
...
### neon vpc endpoint remove (#endpoint-remove)
...
### neon vpc endpoint status (#endpoint-status)
...
### neon vpc project list (#project-list)
...
### neon vpc project restrict (#project-restrict)
...
### neon vpc project remove (#project-remove)
