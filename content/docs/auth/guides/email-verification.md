...
summary: >-
  Managed BetterAuth email verification confirms that users own the email address
...
Managed BetterAuth supports two verification methods:
...
When a user clicks the verification link in their email, the Managed BetterAuth server handles verification and redirects them back to your application. Your app checks for the new session and shows the appropriate UI.
