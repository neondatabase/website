...
summary: >-
  The OpenAPI plugin for Managed Better Auth ships enabled by default and exposes a
...
![Managed Better Auth Open API Reference](/docs/auth/openapi-reference.png)
