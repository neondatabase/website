...
summary: >-
  The Phone Number plugin for Managed Better Auth adds SMS OTP sign-in for existing
  users: when a user submits their E.164 phone number, Managed Better Auth fires a
