---
title: Managed Better Auth roadmap
subtitle: What's supported today and what's coming next
summary: >-
  Managed Better Auth roadmap showing supported frameworks (Next.js, Vite+React, TanStack
...
- [From Managed Better Auth SDK v0.1](/docs/auth/migrate/from-auth-v0.1)
...
We prioritize based on demand. If you need a specific framework or plugin, let us know on our [Discord](https://discord.gg/N8kvBm7qH5).
