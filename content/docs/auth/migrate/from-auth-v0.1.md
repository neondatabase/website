---
title: Migrate from Managed BetterAuth SDK v0.1 to v0.2
subtitle: Upgrade guide for breaking changes in the Managed BetterAuth SDK
summary: >-
  The Managed BetterAuth SDK v0.2 replaces multiple server imports with a single
...
This guide helps you migrate from Managed BetterAuth SDK v0.1.x to v0.2.x, which introduces a unified API and performance improvements through session caching.
...
- [Managed BetterAuth SDK Changelog](https://github.com/neondatabase/neon-js/blob/main/packages/auth/CHANGELOG.md#020-beta1)
