...
<a href="/docs/ai/platform-api-agent-context" description="Give agents context for the Platform API, @neon/sdk, OpenAPI, and MCP" icon="transactions">Agent context for the Platform API</a>
