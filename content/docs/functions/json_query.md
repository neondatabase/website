...
summary: Covers the usage of the `JSON_QUERY()` function in PostgreSQL 17 for extracting and transforming JSON values using SQL/JSON path expressions, including details on wrappers and quote behavior.
