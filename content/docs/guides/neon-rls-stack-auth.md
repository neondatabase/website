...
<DocsList title="Sample project" theme="repo">
  <a href="https://github.com/crialabs-labs/stack-nextjs-neon-rls">Stack Auth + Neon RLS</a>
</DocsList>
...
- A [Stack Auth](https://stack-auth.com/) account with an existing application (e.g., a **todos** app) that uses Stack Auth for user authentication. If you don't have an app, check our [demo](https://github.com/crialabs-labs/stack-nextjs-neon-rls) for similar schema and policies in action.
