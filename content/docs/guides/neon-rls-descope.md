...
<DocsList title="Sample project" theme="repo">
  <a href="https://github.com/crialabs-labs/descope-react-frontend-neon-rls">Descope + Neon RLS</a>
</DocsList>
...
- A [Descope](https://www.descope.com/) account with an existing application (e.g., a **todos** app) that uses Descope for user authentication. If you don't have an app, check our [demo](https://github.com/crialabs-labs/stytch-nextjs-neon-rls) for similar schema and policies in action.
