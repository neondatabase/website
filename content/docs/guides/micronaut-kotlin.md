...
The final application will expose REST endpoints to perform CRUD (Create, Read, Update, Delete) operations on a `book` table in your Neon database. Choose **Connect with neon init** for a quick, guided setup or **Connect manually** for step-by-step instructions.

<Tabs labels={["Connect with neon init", "Connect manually"]}>

<TabItem>

To connect your Micronaut Kotlin app to Neon using AI-assisted setup:
...
1. From your Micronaut Kotlin project root, run [`neon init`](/docs/reference/cli-init):
...
- Configuring your Micronaut Kotlin app to connect to Neon
