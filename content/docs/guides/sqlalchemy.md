...
To connect your SQLAlchemy app to Neon using AI-assisted setup:

<Steps>

## Create a SQLAlchemy project

Set up a Python project with a virtual environment if you do not have one.

## Run neon init

1. From your SQLAlchemy project root, run [`neon init`](/docs/reference/cli-init):
...
- Configuring your SQLAlchemy app to connect to Neon
...
To create a Neon project and access it from an SQLAlchemy application:
