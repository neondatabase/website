...
Your dedicated Postgres replication role must be able to access to the relevant schemas and tables. If necessary, grant read-only access with the following commands. Re-run these command for each schema you expect to replicate data from:
