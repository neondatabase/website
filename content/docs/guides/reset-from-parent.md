...
- You cannot reset a [root branch](/docs/reference/glossary#root-branch), such as the `main` branch of your Neon project or a schema-only branch. These branches have not parent branch.
