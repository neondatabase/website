...
- A [WorkOS](https://www.workos.com) Workspace with an existing application (e.g., a **todos** app) that uses WorkOS for user authentication. If you don't have an app, check our [demo](https://github.com/neondatabase-labs/WorkOS-nextjs-neon-authorize) for similar schema and policies in action.
