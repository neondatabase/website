...
Neon retains a 7-day history of changes for all branches by default, which allows you to create a branch that restores data to any point in time within the defined retention period. You can use this capability to recover lost data, which is a form of Point-in-time restore (PITR).
