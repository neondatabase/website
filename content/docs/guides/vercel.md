...
The Neon Vercel integration connects one Vercel project to one Neon project. The integration does not currently support sharing a PostgreSQL database (a Neon project) between two or more Vercel projects,  nor does it support connecting two PostgreSQL databases (Neon projects) to a single Vercel project.
</Admonition>
