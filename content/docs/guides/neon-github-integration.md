...
subtitle: Connect Lakebase Postgres to a GitHub repository and build GitHub Actions
  workflows
summary: >-
  The Neon GitHub integration connects a Lakebase Postgres project to a GitHub
  ...
  Choose this page to install the integration, add the sample branching
  workflow, or build custom workflows with the create-branch, delete-branch,
  schema-diff, and reset-branch actions. Also covers disconnecting a project,
  removing the integration, and example apps for Vercel, Cloudflare Pages, and
...
The `NEON_API_KEY` allows you to run any [Neon API](/docs/reference/api) method or [Neon CLI](/docs/cli) command, which means you can develop actions and workflows that create, update, and delete various objects in Neon such as projects, branches, databases, roles, and computes.
