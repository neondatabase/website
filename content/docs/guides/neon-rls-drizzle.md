...
Check out our [social wall sample application](https://github.com/crialabs-labs/social-wall-drizzle-neon-rls), a simple schema that demonstrates RLS policies with `crudPolicy`. It implements a social wall where:
