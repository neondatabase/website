...
Neon suspends a compute after five minutes (300 seconds) of inactivity. This behavior can adjusted on Neon's paid plans. For more information, refer to [Configuring Scale to zero for Neon computes](/docs/guides/scale-to-zero-guide).
