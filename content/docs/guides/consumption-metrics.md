...
Neon does not dictate how platform integrations bill their users. Platform integrations can use the data retrieved from the consumption API to generate invoices according to their own billing cycles and preferences.
