...
```bash
psql postgres://daniel:<password>@ep-damp-cell-18160816.us-east-2.aws.neon.tech/neondb < init.sql
```
...
? What is your host? YOUR_NEON_HOST:5432 (e.g., `ep-damp-cell-18160816.us-east-2.aws.neon.tech:5432`)
