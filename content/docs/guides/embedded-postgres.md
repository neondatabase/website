...
<Admonition type="tip" title="Looking for AI agent integration?">
If you're building an AI agent or codegen platform, see [Neon for AI Agents](/docs/guides/ai-agent-integration) for agent-specific features including database versioning and the two-organization structure.
</Admonition>
...
<CTA title="See how platforms use Neon" description="Learn how <a href='/blog/how-retool-uses-retool-and-the-neon-api-to-manage-300k-postgres-databases'>Retool manages 300k+ Postgres databases</a> and <a href='https://www.koyeb.com/blog/serverless-postgres-public-preview'>Koyeb offers serverless Postgres</a> using Neon." ></CTA>
...
1. Generate a Neon API key from your Neon account settings
2. Store the key securely in your environment variables
3. Use the API key to authenticate requests to the Neon API

For detailed API documentation, see the [Neon API Reference](https://api-docs.neon.tech/reference/getting-started-with-neon-api).

You can also use our official SDKs:

- [TypeScript SDK](/docs/reference/typescript-sdk)
- [Python SDK](/docs/reference/python-sdk)
- [@neondatabase/toolkit](/docs/reference/neondatabase-toolkit) (for AI agents)
...
Review the list of [supported Postgres extensions](/docs/extensions/pg-extensions) that Neon currently offers.
...
This is particularly valuable for platforms where users need to test schema changes or experiment with data safely.

### Database-per-tenant architecture

Many platforms use Neon to implement a database-per-tenant architecture for their SaaS applications. For guidance on this pattern, see [Multitenancy with Neon](/docs/guides/multitenancy).
...
Here's how you might structure pricing tiers using Neon's consumption quotas:
...
For real-world examples, see how [Koyeb defines their database instance types](https://www.koyeb.com/docs/databases#database-instance-types).
...
<DetailIconCards>
<a href="/docs/reference/api-reference" description="Explore all available API endpoints" icon="transactions">API Reference</a>
<a href="/docs/introduction/support" description="Get help from our support team" icon="support">Contact Support</a>
