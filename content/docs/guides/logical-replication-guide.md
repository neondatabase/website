...
<a href="/docs/guides/logical-replication-neon" description="Learn about managing schema changes in a logical replication setup" icon="screen">Managing schema changes</a>
