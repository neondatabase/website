...
Logical replication enables data replication and Change Data Capture (CDC) from your Neon databases to a variety of external destinations, including data warehouses, analytical database services, messaging platforms, event-streaming platforms, and external Postgres databases.
