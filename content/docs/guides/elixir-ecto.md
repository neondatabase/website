...
This line tells the application about the the new repo, allowing you to run commands such as `mix ecto.migrate`, which you will use in a later step to create a table in your database (which will verify that your connection works).
