...
- **Branch restore removes replication slots**: [Restoring a branch](/docs/guides/branch-restore) that hosts a publishing database will delete all replication slots on that branch. Replication slots are not recreated during the restore process.
