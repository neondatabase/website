...
isDraft: false
updatedOn: '2023-10-17T23:59:14.598Z'
---

The Neon **Pro** plan is intended for users who have completed their evaluation of Neon on the Free Tier and are ready to transition to a production-level plan with higher limits and advanced features.
...
- **Project sharing:** The _Project sharing_ feature allows you to share your Neon projects with other Neon users. Project sharing is managed on the **Settings** page in the Neon Console. Simply add the Google or GitHub email account of the user you want to share your project with. Projects can be shared with any Neon user, including Free Tier users. Any usage incurred by users you invite to your project is billed to your Neon account. Also, the project owner's limits apply to invited users. For example, when you share a project with a Free Tier user, the Free Tier user operates within your Pro plan project limits rather than their Free Tier project limits. For project sharing instructions, refer to our [Project sharing guide](/docs/guides/project-sharing-guide).
