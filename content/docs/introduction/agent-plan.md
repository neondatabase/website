...
| Compute                         | **$0.106 per CU-hour** <br/> _Same as Launch_                                                         |
...
The paid organization receives $30,000 in initial credits that cover compute ($0.106/hour), storage, and data transfer charges. Usage is tracked per project, and the API exposes consumption metrics for building usage-based billing into your platform.
