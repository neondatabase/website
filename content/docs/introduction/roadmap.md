...
- **Blob Storage**: S3-compatible object storage with metadata in your database as the source of truth. Buckets branch alongside your project, so storage state moves with your data.
