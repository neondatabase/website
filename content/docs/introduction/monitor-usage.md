...
updatedOn: '2024-07-25T19:28:55.402Z'
---
...
- **Compute** usage is tracked in **compute hours**. A compute hour is 1 active hour for a compute with 1 vCPU. For a compute with .25 vCPU, it takes 4 _active hours_ to use 1 compute hour. On the other hand, if your compute has 4 vCPUs, it takes only 15 minutes to use 1 compute hour.
  ...
  On the Free Tier, [default branch](/docs/reference/glossary#default-branch) compute starts at 0.25 vCPU and can run 24/7. Autoscaling up to 2 vCPU with 8 GB RAM is available for extra performance during peak times, though it may affect 24/7 availability depending on your usage patterns. Default branch includes up to a total of 191.9 compute hours per month. Non-default branches share an additional 5 compute hour/month allowance.
  </Admonition>
