...
| [Object Storage](#object-storage)                     | 5 GB, then [rates](#object-storage)        | [rates](#object-storage)                   | [rates](#object-storage)                                                                          |
| [Functions](#functions)                               | [rates](#functions)                        | [rates](#functions)                        | [rates](#functions)                                                                               |
...
[Usage limits](/docs/storage/overview#limits) apply. The following rates apply on all plans:
...
[Usage limits](/docs/compute/functions/reference/runtime-limits) apply. The following rates apply:
