...
You can create read replicas using the Neon Console, [Neon CLI](https://neon.tech/docs/reference/neon-cli), or [Neon API](https://api-docs.neon.tech/reference/getting-started-with-neon-api), providing you with the flexibility you need to integrate read replicas into your workflow or CI/CD processes.
