...
If an auto-debit payment transaction fails, Neon sends a request to update your payment method. Late fees and payment policies are described in the Databricks [Master Cloud Services Agreement](https://www.databricks.com/legal/mcsa) _(Neon is a Databricks Company)_.
