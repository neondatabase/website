...
Ultimately, you should familiarize yourself with capabilities of the `pg_dump`, `psql`, and `pg_restore` utilities and choose the import method best meets your requirements.
...
2. Dump the database from your existing PostgreSQL instance. You can use a `pg_dump` command similar to the following:
    ...
    The `pg_dump` command provides many other options you can use to modify your database dump. To learn more about the options used in the example above and others that are available to you, refer to the [pg_dump](https://www.postgresql.org/docs/current/app-pgdump.html) documentation.
...
3. Load the database dump into Neon using `pg_restore`. For example:
    ...
    The `pg_restore` command provides other options you can use to modify your database import.  To learn more about the options used in the example above and others that are available to you, refer to the [pg_restore](https://www.postgresql.org/docs/current/app-pgrestore.html) documentation.
