...
If this branch has children of its own, resetting is blocked. The error dialog lets you delete these child branches, after which you can continue with the reset.
</Admonition>
