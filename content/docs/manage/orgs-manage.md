...
All members can invite external users to collaborate on specific projects through [project collaboration](/docs/guides/project-collaboration-guide). Collaborators will not have access to the organization Dashboard but can access any projects shared with them from the **Projects** page of their personal account, under **Shared with you**. Collaborators can invite additional Collaborators to the project and remove existing Collaborators from the project.
