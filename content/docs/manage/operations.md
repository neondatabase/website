...
| `Apply storage config` | Applies a new configuration to a database storage object or resource. For example, updating the [history window](/docs/introduction/history-window) for a project initiates this operation.                                                                                                                                      |
...
| `Create timeline`      | Sets up storage and creates the default branch when a Neon [project](/docs/reference/glossary#project) is created.                                                                                                                                                                                                               |
...
You can view system operations via the Neon Console, [Neon CLI](/docs/cli), or [Neon API](/docs/reference/api).
...
See [Get a list of operations](/docs/reference/api/operations/list-project-operations).
</TabItem>
...
This section describes how to work with operations using the [Neon API](/docs/reference/api). The following topics are covered:
...
For attribute definitions, find the [List operations](/docs/reference/api/operations/list-project-operations) endpoint in the [Neon API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
...
For attribute definitions, find the [Retrieve operation details](/docs/reference/api/operations/get-project-operation) endpoint in the [Neon API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
...
You can use the [Get operation details](/docs/reference/api/operations/get-project-operation) method to poll the status of an operation by the operation ID. You might do this at intervals of 5 seconds until the `status` of the operation changes to `finished` before issuing the next request. For example, this request polls the `start_compute` operation shown above:
...
For attribute definitions, find the [Get operation details](/docs/reference/api/operations/get-project-operation) endpoint in the [Neon API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
