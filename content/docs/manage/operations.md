...
| `create_compute`   | Creates a compute endpoint. Creating a compute endpoint, a branch with a compute endpoint, or a Neon project initiates this operation. A Neon project is created with a read-write endpoint by default. For related information, see [Manage compute endpoints](/docs/manage/endpoints).  |
