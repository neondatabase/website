...
| `Apply storage config` | Applies a new configuration to a Neon storage object or resource. For example, updating the restore window period for a project initiates this operation.                                                                                                                                                                     |
