...
| `Apply storage config` | Applies a new configuration to a Neon storage object or resource. For example, updating the [history window](/docs/introduction/history-window) for a project initiates this operation.                                                                                                                                          |
