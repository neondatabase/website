...
To verify your flag, run the get started flow below. Scaffolding and linking work for everyone, and the flag is first checked when `neonctl deploy` enables preview services. If that step fails with "your Neon account isn't in the private preview", post in [#neon-platform-private-preview](https://discord.com/channels/1176467419317940276/1514002115024916643) on Discord and we'll fix your flag.
