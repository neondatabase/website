...
Neon's [architecture](/docs/introduction/architecture-overview) separates compute from storage, which enables serverless features like instant provisioning, [autoscaling](/docs/get-started/built-to-scale#autoscaling), [scale to zero](/docs/get-started/built-to-scale#scale-to-zero), and more.
