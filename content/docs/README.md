...
`DetailIconCards` is a custom MDX component that displays data in a card format. Each card can contain icon, title, href and description. This layout is especially useful for presenting grouped information in a visually pleasing and easy-to-understand way.
