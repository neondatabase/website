...
GIN indexes are most useful when you have multiple values stored in a single column, for example, [hstore](/docs/postgresql/postgresql-hstore), [array](/docs/postgresql/postgresql-tutorial/postgresql-array), jsonb, and range types.
