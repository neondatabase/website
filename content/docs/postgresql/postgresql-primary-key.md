...
redirectFrom:
  - /docs/postgresql/postgresql-tutorial/postgresql-primary-key
...
Technically, a primary key constraint is the combination of a [not-null constraint](/docs/postgresql/postgresql-not-null-constraint) and [a UNIQUE constraint](/docs/postgresql/postgresql-tutorial/postgresql-unique-constraint).
