...
If you attempt to [insert](/docs/postgresql/postgresql-insert) or [update](/docs/postgresql/postgresql-tutorial/postgresql-update) a row with a value not in the list, PostgreSQL will issue an error.
