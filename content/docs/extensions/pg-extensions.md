...
| [pg_session_jwt](/docs/data-api/get-started)                                                     |   0.2.0 |   0.2.0 |   0.2.0 |   0.2.0 | This extension provides JWT session management functionality used by the [Data API](/docs/data-api/get-started).                                                                                                                                                                                                                                                                                                                                              |
