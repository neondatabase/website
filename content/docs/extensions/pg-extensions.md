...
updatedOn: '2026-08-31T20:01:21.799Z'
---
...
Replace `library_to_add` with the libraries you want to enable. Restart your compute afterward so the new libraries load.
