...
| [online_advisor](/docs/extensions/online_advisor)                                                |     1.0 |     1.0 |     1.0 |     1.0 | Requires `shared_preload_libraries` configuration for Postgres 14-16 only. See [Extensions with preloaded libraries](/docs/extensions/pg-extensions#extensions-with-preloaded-libraries).                                                                                                                                                                                                                                                                     |
