...
| :------------------------| --------------------------------------------------------------: | ----------------------------------------------------------------:| ----------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------|
| [address_standardizer](https://postgis.net/docs/Extras.html#Address_Standardizer)     | 3.3.2  | 3.3.2  |    3.3.3  |                                                                                                          |
| [address_standardizer_data_us](https://postgis.net/docs/Extras.html#Address_Standardizer)      | 3.3.2        | 3.3.2 | 3.3.3 |                                                                                                 |
...
| [pg_embedding](https://github.com/neondatabase/pg_embedding)             | 0.3.50           | 0.3.5  | 0.3.5            | Install with `CREATE EXTENSION embedding;`                                                                         |
...
| [pg_hint_plan](https://github.com/ossc-db/pg_hint_plan)             | 1.5                  | 1.5                  |  1.5                  |                                                                                                                   |
| [pg_jsonschema](https://github.com/supabase/pg_jsonschema)            | 0.1.4              | 0.1.4               |  0.1.4               |                                                                                                                  |
