...
updatedOn: '2025-10-07T17:55:58.911Z'
---
...
| [h3_postgis](/docs/extensions/postgis-related-extensions#h3-and-h3-postgis)                      |   4.1.3 |   4.1.3 |   4.1.3 |   4.1.3 |      - | Install with `CREATE EXTENSION h3_postgis CASCADE;` (requires `postgis` and `postgis_raster`)                                                                                                                                                                                                                                                                                                                                                                 |
...
| [neon](/docs/extensions/neon)                                                                    |     1.7 |     1.7 |     1.7 |     1.7 |    1.7 |                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
|                                                                                                  |
| [pg_graphql](/docs/extensions/pg_graphql)                                                        |  1.5.11 |  1.5.11 |  1.5.11 |  1.5.11 |      - |                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| [pg_session_jwt](/docs/data-api/get-started)                                                     |   0.3.1 |   0.3.1 |   0.3.1 |   0.3.1 |  0.3.1 | This extension provides JWT session management functionality used by the [Data API](/docs/data-api/get-started).                                                                                                                                                                                                                                                                                                                                              |
...
| [postgis_sfcgal](/docs/extensions/postgis-related-extensions#postgis-sfcgal)                     |   3.3.3 |   3.3.3 |   3.3.3 |   3.5.0 |      - |                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
