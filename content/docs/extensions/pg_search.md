...
- **BM25 search**: [`lakebase_text`](/docs/extensions/lakebase-text) — a BM25 index for Neon, fully compatible with `tsvector` (Beta); or [ParadeDB](https://www.paradedb.com/) for continued `pg_search` functionality
