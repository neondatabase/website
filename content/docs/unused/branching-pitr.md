...
The history retention period is configurable. The supported limits are 24 hours for [Neon Free Plan](/docs/introduction/plans#free-plan) users, 7 days for [Launch](/docs/introduction/plans#launch) plan users, 14 days for [Scale](/docs/introduction/plans#scale) plan users, and 30 days for [Business](/docs/introduction/plans#business). For configuration instructions, see [Configure history retention](/docs/manage/projects#configure-history-retention).
