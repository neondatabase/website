...
A Neon project is created with a default Postgres role named for your account, and a default database named `neondb`. This guide uses the `neondb` database as the primary database.
</Admonition>
