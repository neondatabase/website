...
![join us at Neon Deploy](/docs/changelog/neon-deploy.png)
...
![azure project creation globe](/docs/changelog/azure_beta.png)
...
![account metrics widget on all projects page](/docs/changelog/account_metrics_widget.png)
...
![project metrics on individual project page](/docs/changelog/project_limits_widget.png)
...
- We've removed deprecated language and actions from the Neon CLI. A few months ago, we started calling your root branch `default` instead of `primary`. The CLI now reflects this change: `primary` is no more, it's `default` everywhere. For more info, see [set-default](/docs/cli/branches#set-default).
