...
If you use the [Neon CLI](/docs/cli), here’s a friendly reminder to upgrade to the latest version. The current version is 2.6.0, and all users should now be on a 2.x version. You can check your Neon CLI version with the following command:
...
For upgrade instructions, see [Neon CLI upgrade](/docs/cli/install#upgrade).
