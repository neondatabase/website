...
- Fixed an issue with the [Neon Vercel Integration](/docs/guides/vercel-overview) that caused a `Something went wrong` error when creating a new Neon project during integration installation.
