...
- **Neon API changes**
  - Updated the [Create Project](/docs/reference/api/projects/create-project) API to return a 404 error instead of a 500 error when an invalid region is specified.
