...
First, [create a table](/postgresql/postgresql-create-table) called `person` that includes a `JSONB` column:
...
Second, [insert a new row](/postgresql/postgresql-insert) into the `person` table:
