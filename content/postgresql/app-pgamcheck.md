...
*`dbname`* can also be a [connection string](libpq-connect#LIBPQ-CONNSTRING).
...
* `-d pattern``--database=pattern`
  ...
  Check databases matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS), except for any excluded by `--exclude-database`. This option can be specified more than once.

* `-D pattern``--exclude-database=pattern`

  Exclude databases matching the given [*`pattern`*](app-psql#APP-PSQL-PATTERNS). This option can be specified more than once.

* `-i pattern``--index=pattern`

  Check indexes matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS), unless they are otherwise excluded. This option can be specified more than once.
...
* `-I pattern``--exclude-index=pattern`
  ...
  Exclude indexes matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS). This option can be specified more than once.
...
* `-r pattern``--relation=pattern`
  ...
  Check relations matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS), unless they are otherwise excluded. This option can be specified more than once.
...
* `-R pattern``--exclude-relation=pattern`
  ...
  Exclude relations matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS). This option can be specified more than once.

  As with `--relation`, the [*`pattern`*](app-psql#APP-PSQL-PATTERNS) may be unqualified, schema-qualified, or database- and schema-qualified.

* `-s pattern``--schema=pattern`

  Check tables and indexes in schemas matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS), unless they are otherwise excluded. This option can be specified more than once.
...
* `-S pattern``--exclude-schema=pattern`
  ...
  Exclude tables and indexes in schemas matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS). This option can be specified more than once.

  As with `--schema`, the pattern may be database-qualified.

* `-t pattern``--table=pattern`

  Check tables matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS), unless they are otherwise excluded. This option can be specified more than once.
...
* `-T pattern``--exclude-table=pattern`
  ...
  Exclude tables matching the specified [*`pattern`*](app-psql#APP-PSQL-PATTERNS). This option can be specified more than once.
