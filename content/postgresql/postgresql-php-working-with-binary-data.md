...
PostgreSQL does not support the BLOB data type. However, you can use the [BYTEA data type](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-bytea-data-type/) for storing the binary string.



We'll [create a new table](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-create-table/) called `company_files` to store the binary string:
...
1. 2. First, prepare a [SELECT](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-select/) statement.
3. 4.
