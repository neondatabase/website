...
This tutorial begins where the [Inserting data into a table in PostgreSQL tutoria](/postgresql/postgresql-csharp/postgresql-csharp-insert)l left off.
...
-
- Second, iterate over the list and [insert each record into the table](/postgresql/postgresql-csharp/postgresql-csharp-insert).
