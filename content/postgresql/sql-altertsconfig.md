...
[CREATE TEXT SEARCH CONFIGURATION](sql-createtsconfig "CREATE TEXT SEARCH CONFIGURATION"), [DROP TEXT SEARCH CONFIGURATION](sql-droptsconfig "DROP TEXT SEARCH CONFIGURATION")