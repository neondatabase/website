...
redirectFrom:
            ...
            - /postgresql/postgresql-string-functions/postgresql-to_number
tableOfContents: true
---

**Summary**: in this tutorial, you will learn how to use the PostgreSQL `TO_NUMBER()` function to convert a [character string](/postgresql/postgresql-char-varchar-text) to a [numeric](/postgresql/postgresql-tutorial/postgresql-numeric) value according to a specified format.
