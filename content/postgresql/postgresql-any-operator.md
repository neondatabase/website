...
The PostgreSQL `ANY` operator compares a value with a set of values returned by a [subquery](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-subquery/). It is commonly used in combination with comparison operators such as =, &lt;, >, &lt;=, >=, and &lt;>.
