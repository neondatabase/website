...
redirectFrom:
            ...
            - /postgresql/postgresql-json-functions/postgresql-jsonb_agg
...
The `jsonb_agg()` function is an [aggregate function](/postgresql/postgresql-aggregate-functions) that allows you to aggregate values into a JSON array.
...
First, [create new tables](/postgresql/postgresql-create-table) called `departments` and `employees`:
