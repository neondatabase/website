...
redirectFrom: 
            ...
            - /postgresql/postgresql-json-functions/postgresql-jsonb_insert
...
The `jsonb_insert()` function allows you to insert new values into a [JSON](/postgresql/postgresql-json) document of the JSONB type.
...
First, [create a new table](/postgresql/postgresql-create-table) called `employee_profiles`:
...
Second, [insert rows](/postgresql/postgresql-insert-multiple-rows) into the `employee_profiles` table:
