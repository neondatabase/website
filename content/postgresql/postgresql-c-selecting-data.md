...
This tutorial begins where [Deleting data from PostgreSQL using C#](/postgresql/postgresql-csharp/postgresql-csharp-delete) is left off.
...
- `ExecuteScalarAsync()` - executes a query that returns a scalar value such as a query that uses an [aggregate function](/postgresql/postgresql-aggregate-functions) to return a [count](/postgresql/postgresql-aggregate-functions/postgresql-count-function), [sum](/postgresql/postgresql-aggregate-functions/postgresql-sum-function), [maximum](/postgresql/postgresql-aggregate-functions/postgresql-max-function), [minimum](/postgresql/postgresql-aggregate-functions/postgresql-min-function), and [average value](/postgresql/postgresql-aggregate-functions/postgresql-avg-function).
...
The following program shows how to select the total number of students from the `students` table using the [count(\*)](/postgresql/postgresql-aggregate-functions/postgresql-count-function) aggregate function:
