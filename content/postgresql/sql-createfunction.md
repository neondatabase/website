...
* `SUPPORT` *`support_function`*
  ...
  The name (optionally schema-qualified) of a *planner support function* to use for this function. See [Section 38.11](xfunc-optimization) for details. You must be superuser to use this option.
