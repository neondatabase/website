...
These settings control the behavior of the built-in *streaming replication* feature (see [Section 27.2.5](warm-standby#STREAMING-REPLICATION)), and the built-in *logical replication* feature (see [Chapter 31](logical-replication)).
