...
Let's [create a simple table](/postgresql/postgresql-create-table) for demonstration:
...
Note that you'll learn how to [create a table](/postgresql/postgresql-create-table) and [insert data into it](/postgresql/postgresql-tutorial/postgresql-insert-multiple-rows) in the upcoming tutorials.
