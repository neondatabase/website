...
Typically, you define a generated column when [creating a table ](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-create-table/)with the following syntax:
...
To add a generated column to a table, you can use the [ALTER TABLE ... ADD COLUMN](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-add-column/) statement:
...
- - The expression can only use immutable functions and cannot involve [subqueries](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-subquery/) or reference anything beyond the current row. For example, the expression cannot use the [CURRENT_TIMESTAMP](https://www.postgresqltutorial.com/postgresql-date-functions/postgresql-current_timestamp/) function.
- -
