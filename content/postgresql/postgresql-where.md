...
If you use [column aliases](/postgresql/postgresql-column-alias) in the `SELECT` clause, you cannot use them in the `WHERE` clause.
...
| [IN](/postgresql/postgresql-in)           | Return true if a value matches any value in a list  |
| [BETWEEN](/postgresql/postgresql-between) | Return true if a value is between a range of values |
| [LIKE](/postgresql/postgresql-like)       | Return true if a value matches a pattern            |
| [IS NULL](/postgresql/postgresql-is-null) | Return true if a value is NULL                      |
...
We will use the `customer` table from the [sample database](/postgresql/postgresql-getting-started/postgresql-sample-database) for demonstration.
