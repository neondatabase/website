...
The following example uses a [common table expression](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-cte/) (CTE) to generate the bucket numbers and then calculate the frequency of films falling into each bucket:
