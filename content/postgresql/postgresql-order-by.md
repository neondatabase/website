...
We will use the `customer` table in the [sample database](/postgresql/postgresql-getting-started/postgresql-sample-database) for the demonstration.
...
Let's [create a table](/postgresql/postgresql-create-table) for the demonstration.
