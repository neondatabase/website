...
* [F.25. pageinspect — low-level inspection of database pages](pageinspect)
  ...
  * [F.27. pg\_buffercache — inspect PostgreSQL buffer cache state](pgbuffercache)
...
* [F.32. pg\_stat\_statements — track statistics of SQL planning and execution](pgstatstatements)
...
|                                |                                     |                             |                                           |
| ------------------------------ | ----------------------------------- | --------------------------- | ----------------------------------------- |
| [btree\_gin](btree-gin)   | [fuzzystrmatch](fuzzystrmatch) | [ltree](ltree)         | [tcn](tcn)                           |
| [btree\_gist](btree-gist) | [hstore](hstore)               | [pgcrypto](pgcrypto)   | [tsm\_system\_rows](tsm-system-rows) |
| [citext](citext)          | [intarray](intarray)           | [pg\_trgm](pgtrgm)     | [tsm\_system\_time](tsm-system-time) |
| [cube](cube)              | [isn](isn)                     | [seg](seg)             | [unaccent](unaccent)                 |
| [dict\_int](dict-int)     | [lo](lo)                       | [tablefunc](tablefunc) | [uuid-ossp](uuid-ossp)               |
