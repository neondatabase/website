...
In PostgreSQL, a [common table expression (CTE)](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-cte/) is a named temporary result set within a query.
...
- -
- - Finally, return the final result set that is a [UNION](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-union/) or `UNION ALL` of the result sets R0, R1, ... Rn.
- 
