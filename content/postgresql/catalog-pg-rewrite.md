...
| `ev_class` `oid` (references [`pg_class`](catalog-pg-class "53.11. pg_class").`oid`)The table this rule is for                                                                                                                                                                   |
| `ev_type` `char`Event type that the rule is for: 1 = [SELECT](sql-select "SELECT"), 2 = [UPDATE](sql-update "UPDATE"), 3 = [INSERT](sql-insert "INSERT"), 4 = [DELETE](sql-delete "DELETE")                                                                       |
