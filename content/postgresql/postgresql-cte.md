...
A common table expression (CTE) allows you to create a temporary result set within a [query](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-select/).
...
- -
- - Ability to create [recursive queries](https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-recursive-query/), which are queries that reference themselves. The recursive queries come in handy when you want to query hierarchical data such as organization charts.
- -
