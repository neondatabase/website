...
| `amhandler` `regproc` (references [`pg_proc`](catalog-pg-proc "53.39. pg_proc").`oid`)OID of a handler function that is responsible for supplying information about the access method |
