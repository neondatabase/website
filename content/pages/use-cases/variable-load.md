...
This method creates two inefficiencies:
...
### Overprovision \- or buying larger instances than you think you need
...
### Read replicas don’t duplicate budgets
...
<Admonition type="info">
Our [platform data](https://neon.com/autoscaling-report) shows that Neon read replicas use 4x less compute than their provisioned equivalent and cost around 78% less.
</Admonition>
