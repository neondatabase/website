...
Aggregate metrics across all projects in the account
Scale and Business plans
Granular project-level metrics
Usage metrics per project at hourly, daily, or monthly granularity
Scale and Business plans
Single project metrics
Detailed metrics and quota info for an individual project
All plans
