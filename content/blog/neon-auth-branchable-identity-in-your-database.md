...
cover:
  image: >-
    https://cdn.neonapi.io/public/images/pages/blog/neon-auth-branchable-identity-in-your-database/cover.jpg
  alt: null
isFeatured: true
seo:
...
source:
  wpId: 11786
  wpSlug: neon-auth-branchable-identity-in-your-database
...
<source src="https://cdn.neonapi.io/public/videos/pages/blog/neon-auth-branchable-identity-in-your-database/neon-auth-web-e2e5b359.mp4" />
</video>
...
> **_Note that neon.js or JavaScript is not required to use Neon Auth._** _You can integrate with Neon Auth using the API or any HTTP client. neon.js is simply the easiest way to use Auth, Data API, and the database together._
