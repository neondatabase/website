...
An alternative would be to create your own RAG app that uses open-source tools and models such as [Mixtral 8x7B](https://neon.com/blog/mixtral-8x7b-what-you-need-to-know-about-mistral-ais-latest-model) and [pgvector](https://neon.com/docs/extensions/pgvector). Learn more about [AI concepts](https://neon.com/docs/ai/ai-concepts) and [how to use create a chatbot using pgvector and Next.js](https://neon.com/blog/building-an-ai-powered-chatbot-using-vercel-openai-and-postgres).
