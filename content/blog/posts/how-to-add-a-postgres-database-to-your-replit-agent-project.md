...
<figure>
<video height="1008" style={{ aspectRatio: "1022 / 1008" }} width="1022" autoPlay muted loop src="https://cdn.neonapi.io/public/videos/pages/blog/how-to-add-a-postgres-database-to-your-replit-agent-project/snake-game-2-1ff291f6.mov" playsInline></video>
</figure>
...
<blockquote>
<p><em>Let’s implement a leaderboard so that we can keep track of all the scores. The high score on the app should reflect the number 1 spot on the leaderboard. Users should be able to enter their names (up to 3 characters). </em></p>
</blockquote>
...
<figure>
<video height="1084" style={{ aspectRatio: "1104 / 1084" }} width="1104" autoPlay muted loop src="https://cdn.neonapi.io/public/videos/pages/blog/how-to-add-a-postgres-database-to-your-replit-agent-project/snake-improved-298c2d5f.mov" playsInline></video>
</figure>
...
<blockquote>
<p>Replit Agent is smart enough to recognize when your app needs persistent storage and will often add a Postgres database automatically.</p>
</blockquote>
