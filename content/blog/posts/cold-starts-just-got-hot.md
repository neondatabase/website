...
excerpt: >-
  tl;dr> Over the past few months, a bunch of efforts by the engineering team
  have greatly reduced our “cold start time” for compute resources for idle
  computes that become active. This post explores the problem and how the Neon
...
<blockquote>
<p><em>tl;dr> Over the past few months, a bunch of efforts by the engineering</em><br></br><em>team have greatly reduced our “cold start time” for compute resources</em><br></br><em>for idle computes that become active. This post explores the problem</em><br></br><em>and how the Neon team worked on this problem.</em></p>
</blockquote>
