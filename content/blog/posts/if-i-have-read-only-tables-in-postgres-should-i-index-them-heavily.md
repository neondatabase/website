...
<blockquote>
<p><strong>TL;DR:</strong> For small tables, full table scans can be as efficient or even more efficient than using an index. Postgres can load small tables into memory, making sequential scans very fast.</p>
</blockquote>
...
<blockquote>
<p><strong>TL;DR: </strong>For larger tables and simple queries that touch a significant portion of the table, indexes can slow things down. For complex queries involving multiple conditions, indexes can significantly improve performance.</p>
</blockquote>
...
<blockquote>
<p><strong>TL;DR: </strong>Remember that indexing heavily might affect your resource consumption. </p>
</blockquote>
