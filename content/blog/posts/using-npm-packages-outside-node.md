...
<blockquote>
<p>Some platforms make an effort to help you with this. For example, on Cloudflare Workers you can add a setting <code>node_compat = true</code> to <code>wrangler.toml</code>, which makes some effort to provide Node-specific functionality. But this can’t fix every issue, and it’s not available everywhere.</p>
</blockquote>
