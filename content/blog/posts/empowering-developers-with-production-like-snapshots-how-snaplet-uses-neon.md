...
- **When users require a new preview database, Snaplet creates a branch from the main snapshot branch.** This process is quick and efficient, leveraging [Neon’s copy-on-write technology](https://neon.com/blog/get-page-at-lsn) to avoid unnecessary data duplication.
