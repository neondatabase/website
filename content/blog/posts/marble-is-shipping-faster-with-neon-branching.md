...
<blockquote>
<p><strong>“We recently shipped a big update and we probably couldn’t have done it without Neon branching. It lets us test big migrations safely with production data, and if something breaks, we just delete the branch and start fresh. That makes us a lot faster and more confident when shipping, even as a small team”</strong> <em>(Dominik Koch, CEO and Co-Founder of Marble)</em></p>
</blockquote>
...
<figcaption><em>https://marblecms.com/</em></figcaption>
</figure>
...
<figcaption><em>A sneak peek into Marble’s dashboard</em></figcaption>
</figure>
...
_[Join our Discord](https://discord.gg/N8kvBm7qH5) to ask us any questions and interact with the Neon community_.
