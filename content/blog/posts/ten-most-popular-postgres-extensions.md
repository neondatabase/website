...
<blockquote>
<p><strong>Installed in 1M+ databases</strong>. If you’re writing Postgres functions, you’re using plpgsql, whether you know it or not.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 1M+ databases.</strong> It’s the go-to tool for spotting slow queries and understanding what your database is actually doing.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 80k+ databases.</strong> It’s the most common way to generate UUIDs directly inside Postgres.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 30k+ databases. </strong>pgvector allows you to store and search embedding vectors inside Postgres, turning it into a vector database.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 20k+ databases. </strong>pgcrypto is useful for secure hashing, encryption, and random value generation.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 10k+ databases. </strong>This extension makes Postgres great at finding similar strings.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 8k+ databases.</strong> postgis turns Postgres into a full-featured spatial database, making it one of the most powerful extensions out there.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 4k+ databases.</strong> citext enables case-insensitive text matching without workarounds.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 2.5k+ databases.</strong> <code>unaccent</code> strips accents from characters for more flexible text search.</p>
</blockquote>
...
<blockquote>
<p><strong>Installed in 1k+ databases.</strong> hstore lets you store key-value pairs inside a single column.</p>
</blockquote>
