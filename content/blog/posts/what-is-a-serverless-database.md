...
Scaling up and down is where it starts. Still, the real value of serverless starts to be felt when developers realize with an [API](https://neon.com/docs/reference/api/get-started) and a [command line tool](https://neon.com/docs/cli) at their fingertip, they can spin up new databases and [database branches](https://neon.com/docs/introduction/branching) instantaneously. No more raising tickets, talking to DBAs, speculating about disk space and load. The introduction of a complete serverless Platform abstracts away all the historical operational and administrative burdens of developing on Postgres.
