...
Check out the [docs on event triggers](https://www.postgresql.org/docs/current/event-triggers.html) for more. And if you have questions, [find us on Discord](https://neon.com/discord).
