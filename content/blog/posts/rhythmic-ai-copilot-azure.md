...
<blockquote>
<p><strong>“We needed fast, programmatic provisioning of Postgres on Azure, support for pgvector and RAG, and something that could scale easily across tenants. Neon checked all those boxes”</strong> <em>(<a href="https://www.linkedin.com/in/chrisisagile/">Chris Sims</a>, CEO and co-founder of <a href="https://www.gorhythmic.com/">Rhythmic</a>)  </em></p>
</blockquote>
...
<blockquote>
<p>“The best products are built when humans get out of the office and interact with customers. We’re using AI to automate the busywork that gets in the way of that” <em>(<em><a href="https://www.linkedin.com/in/chrisisagile/">Chris Sims</a>, CEO and co-founder of <a href="https://www.gorhythmic.com/">Rhythmic</a></em>)</em>  </p>
</blockquote>
...
<figcaption>Read about it – <a href="https://www.gorhythmic.com/">gorhythmic.com</a></figcaption>
</figure>

## Choosing Neon on Azure

<blockquote>
<p>“Postgres fits with our architecture, and Neon made it easy. I didn’t want to deal with any overhead, Neon worked out of the box and let us stay focused.” <em>(<em><a href="https://www.linkedin.com/in/chrisisagile/">Chris Sims</a>, CEO and co-founder of <a href="https://www.gorhythmic.com/">Rhythmic</a></em>)  </em></p>
</blockquote>
...
<blockquote>
<p><strong>“Getting started with Neon Azure Native Integration was trivial, which is exactly what you want. We clicked a few buttons, changed some keys, and everything just worked.”</strong> <em>(<em><a href="https://www.linkedin.com/in/chrisisagile/">Chris Sims</a>, CEO and co-founder of <a href="https://www.gorhythmic.com/">Rhythmic</a></em>)  </em></p>
</blockquote>
