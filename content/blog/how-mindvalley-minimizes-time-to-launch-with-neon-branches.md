...
source:
  wpId: 7284
  wpSlug: how-mindvalley-minimizes-time-to-launch-with-neon-branches
...
> **“Developers already face significant delays when working on a PR—running CI tests, ensuring everything is ready for preview, it all adds up. Time to launch is crucial for us: when we tried Neon and saw that spinning up a new branch takes seconds, we were blown away”** (_Alex Co, Head of Platform Engineering at Mindvalley)_
...
> “We are using the Neon Twin workflow. We just install the GitHub action and it takes care of the rest. Developers may not know how to dump and restore well, but they know how to run a GitHub Action. It’s amazing” (_Alex Co, Head of Platform Engineering at Mindvalley_)
