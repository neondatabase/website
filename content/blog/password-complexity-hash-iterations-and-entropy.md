...
source:
  wpId: 6023
  wpSlug: password-complexity-hash-iterations-and-entropy
...
<figcaption>Example of a database URL in Neon, don’t worry this one is long gone.</figcaption>
</figure>
...
Brute-force strength = password-entropy + log2(PBKDF2 iterations)
