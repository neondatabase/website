...
source:
  wpId: 12128
  wpSlug: reusable-prompts-the-future-of-starter-templates
...
[shadcn/ui](http://Learning from shadcn shadcn/ui has revolutionized how we think about UI component libraries: instead of installing a package of components, you own the code and copy the building blocks directly into your codebase. To automate the copy & pasting, we can further use the shadcn CLI:) has revolutionized how we think about UI component libraries: instead of installing a package of components, you own the code and copy the building blocks directly into your codebase. To automate the copy & pasting, we can further use the shadcn CLI:
...
> Review how we manage environment variables in this codebase and draft step-by-step setup instructions that include all relevant code one-to-one from the codebase in a Markdown file named `config-setup.md`
