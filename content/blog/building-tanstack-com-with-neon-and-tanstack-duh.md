...
source:
  wpId: 12240
  wpSlug: building-tanstack-com-with-neon-and-tanstack-duh
...
> **“Neon was so easy to get started, and it worked flawlessly with TanStack Start and TanStack Query. When you start a new project with TanStack Start and select Neon in the CLI, you get a working database instantly and later you can go claim it, which is one of the coolest things I’ve seen”**<br /><br />([Tanner Linsley](https://x.com/tannerlinsley?s=20), founder of [TanStack](https://tanstack.com/))
