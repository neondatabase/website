...
source:
  wpId: 8720
  wpSlug: building-a-vscode-chat-extension-to-order-lunch
...
> **User:**<br />Hey LLM I have this function called add that takes parameters `\{num1: int, num2: int\}` only respond with JSON so I can parse it from the response. Please add 5 and 9<br /><br />**Assistant**:<br />\{num1: 5, num2: 9\}
