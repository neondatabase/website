...
source:
  wpId: 10452
  wpSlug: six-principles-for-production-ai-agents
...
All LLM providers have educational resources on best practices on how to prompt their models (e.g., [one by Anthropic](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) and [one by Google](https://ai.google.dev/gemini-api/docs/prompting-strategies)). Just follow them and ensure your instructions are direct and detailed, no smart-pants tricks required. For example, here is a [system prompt](https://github.com/appdotbuild/claude_astgrep/blob/main/.claude/commands/ast_grep.md) we use to make Claude generate rules for [ast-grep](https://ast-grep/ast-grep:%20%E2%9A%A1A%20CLI%20tool%20for%20code%20structural%20search,%20lint%20and%20rewriting.%20Written%20in%20Rust) – nothing tricky, just details on how to use the tool that the agent barely knows.
...
![Image](https://cdn.neonapi.io/public/images/pages/blog/six-principles-for-production-ai-agents/729-960x1024-aa894a54.jpg)
...
![Image](https://cdn.neonapi.io/public/images/pages/blog/six-principles-for-production-ai-agents/screenshot-2025-07-28-at-94002percente2percent80percentafam-1024x602-e4a6b5b7.png)
