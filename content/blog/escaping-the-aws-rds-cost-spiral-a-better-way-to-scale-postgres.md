...
source:
  wpId: 9733
  wpSlug: escaping-the-aws-rds-cost-spiral-a-better-way-to-scale-postgres
...
> **“We need multi-terabyte dev environments to mirror prod. In RDS, that means duplicating storage, and the costs are ridiculous.”**<br /><br />_Engineer at a logistics company. Migrated TB-size workload from RDS to Neon_
