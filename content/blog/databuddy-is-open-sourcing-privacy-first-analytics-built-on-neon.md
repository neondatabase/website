...
source:
  wpId: 10744
  wpSlug: databuddy-is-open-sourcing-privacy-first-analytics-built-on-neon
  exportedAt: '2026-03-20T13:31:00.745Z'
---

![Image](https://cdn.neonapi.io/public/images/pages/blog/databuddy-is-open-sourcing-privacy-first-analytics-built-on-neon/neon-databuddy-1024x576-3d49c950.jpg)

> **“I was surprised by how fast Neon was. It was faster than my self-hosted setup and Prisma Postgres. This plus the convenience of the Free Plan makes it a no-brainer for building your projects.”** (Issa Nassar, founder of [Databuddy](https://www.databuddy.cc/))
...
<figure>
<img src="https://cdn.neonapi.io/public/images/pages/blog/databuddy-is-open-sourcing-privacy-first-analytics-built-on-neon/ad4nxf0yplfzjebagb2qdgqtte6y9zqpebkxc5gh-mhgsm6sasrv6rodkfxyofy8evsbmgzwh815xqtj4cfajf2tdxmf9pedwf6qobci9uqbxlzx0w-iut1qvqie0hjr9kzwgvj6jc8w-34601923.png" alt="Image" />
<figcaption>Try it out at https://www.databuddy.cc/</figcaption>
</figure>

## Building on Neon: Top Postgres Performance Without the Hassle

> **“I’ve been through the pain of self-hosting: setting everything up, tuning PgBouncer, dealing with connection limits. Neon gives me great performance without the maintenance”** ([Issa Nassar](https://x.com/izadoesdev), founder of [Databuddy](https://www.databuddy.cc/))
...
> **“This is a really simple setup that works. Neon handles the transactional side, ClickHouse handles the heavy lifting, and I get to choose exactly how everything else fits together”** ([Issa Nassar](https://x.com/izadoesdev), founder of [Databuddy](https://www.databuddy.cc/))
