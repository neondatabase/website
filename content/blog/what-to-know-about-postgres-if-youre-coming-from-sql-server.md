...
source:
  wpId: 7878
  wpSlug: what-to-know-about-postgres-if-youre-coming-from-sql-server
...
<figcaption>You’re not the only one considering Postgres: look at those trends</figcaption>
</figure>
