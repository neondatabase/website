...
source:
  wpId: 10514
  wpSlug: dyad-brings-postgres-to-local-ai-app-building-powered-by-neon
...
<EmbedTweet url="https://twitter.com/dyad_sh/status/1952800981185610094?ref_src=twsrc%5Etfw" text="🚀 Dyad v0.16.0 Beta is here! Introducing the Portal template—our most powerful template yet for building business apps with advanced user roles & permissions. Powered by @neondatabase (with database undo!) and @payloadcms for prebuilt admin panels. Building apps with AI… pic.twitter.com/7ZgW22KjXp — Dyad ✨ local vibe coding tool (@dyad_sh) August 5, 2025" />
