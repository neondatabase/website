...
source:
  wpId: 8008
  wpSlug: three-signs-its-time-to-move-away-from-rds
...
> “Neon’s branching paradigm has been great for us. It lets us create isolated environments without having to move huge amounts of data around. This has lightened the load on our ops team, now it’s effortless to spin up entire environments.” _Jonathan Reyes, Principal Engineer at Dispatch –_ [Read case study](https://neon.tech/blog/how-dispatch-speeds-up-development-with-neon-while-keeping-workloads-on-aurora)

> “Developers already face significant delays when working on a PR—running CI tests, ensuring everything is ready for preview, it all adds up. Time to launch is crucial for us: when we tried Neon and saw that spinning up a new branch takes seconds, we were blown away” – _Alex Co, Head of Platform Engineering at Mindvalley –_ [Read case study](https://neon.tech/blog/how-mindvalley-minimizes-time-to-launch-with-neon-branches)
...
> “Instead of having to overprovision our servers to handle peak loads, which leads to inefficiencies and higher costs, Neon’s autoscaling handles it. We get more performance when we need it” – _Julian Benegas, CEO of BaseHub_ – [Read case study](https://neon.tech/blog/meet-basehub-developer-velocity-and-efficiency-right-down-to-the-database)

> “Neon perfectly meets our needs for a Postgres solution that scales with demand. We can push the boundaries of what’s possible in our projects without compromising efficiency or costs” – _Technical Director at White Widget_ – [Read case study](https://neon.tech/blog/white-widgets-secret-to-scalable-postgres-neon)
...
> “Our customers require their data to live in an isolated database, but implementing this in RDS was cumbersome and expensive. We switched over to Neon to reduce costs and operational overhead” – _Joey Teunissen, CTO at OpusFlow_ – [Read case study](https://neon.tech/blog/how-opusflow-achieves-tenant-isolation-in-postgres-without-managing-servers)

> “We’ve been able to automate virtually all database management tasks via the Neon API. This saved us a tremendous amount of time and engineering effort. Neon allows us to offer dedicated databases to our customers without worrying about the cost of idle resources” – _Himanshu Bhandoh, Software Engineer at Retool_ –[Read case study](https://neon.tech/blog/how-retool-uses-retool-and-the-neon-api-to-manage-300k-postgres-databases)
