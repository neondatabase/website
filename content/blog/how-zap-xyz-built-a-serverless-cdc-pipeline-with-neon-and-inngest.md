...
source:
  wpId: 8495
  wpSlug: how-zap-xyz-built-a-serverless-cdc-pipeline-with-neon-and-inngest
...
> **“Inngest + Neon handle the entire change data capture process for us. Setting it up took a fraction of the time compared to AWS”** (Jacob Devore, Co-Founder at [Zap](https://zap.xyz/login))
...
<EmbedTweet url="https://twitter.com/fomomofosol/status/1878684577985970340?ref_src=twsrc%5Etfw" text="Pump vision / meme scope….. but with real time telegram caller updates 😳 Probably one of the most unique entries to the trading bot space. Testing it out rn: https://t.co/uXaBj199i3 pic.twitter.com/cNtZm10lx1 — fomo 🐕🧲 (@fomomofosol) January 13, 2025" />
...
> **“If you’re a startup working on a product like ours, every second counts. Developer experience and iteration speed are crucial. We just don’t have time to wrestle with clunky infrastructure”** (Jacob Devore, Co-Founder at [Zap](https://zap.xyz/login))
...
> **“We spent about 10 hours just trying to build a proof of concept in AWS, and this was for something as straightforward as “when a row is added to the database, run some code once.” It was a huge time sink.”** (Jacob, Co-Founder at [Zap](https://zap.xyz/login))
...
> **“With Inngest, we don’t need to stand up a stream service or maintain it. We just subscribe to database events and then define what needs to happen next. It’s basically zero overhead”** (Jacob Devore, Co-Founder at [Zap](https://zap.xyz/login))
