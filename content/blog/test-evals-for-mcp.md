...
- The “complete*database_migration” tool \_completes* the migration, which means that it will actually run it on the “main” branch and then it will delete the temporary branch which was created by the “prepare_database_migration” tool.
