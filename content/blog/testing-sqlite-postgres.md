...
source:
  wpId: 8508
  wpSlug: testing-sqlite-postgres
...
> _The performance characteristics will be very different in most cases. Often faster. It’s typically good for testing because the SQLite engine does not need to take into account multiple client access. SQLite only allowed one thread to access it at once. This greatly reduces a lot of the overhead and complexity compared to other RDBMSs._ ([Matt Williamson](https://stackoverflow.com/a/20531857))
