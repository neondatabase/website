...
source:
  wpId: 5294
  wpSlug: white-widgets-secret-to-scalable-postgres-neon
...
<figcaption>Neon architecture decouples storage and compute in Postgres, introducing a custom storage engine to support a serverless experience.</figcaption>
</figure>
