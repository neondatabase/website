...
source:
  wpId: 8888
  wpSlug: nodecraft-cloudflare-neon
...
> **“Moving from legacy infrastructure to a fully serverless stack has been a huge upgrade. We wanted our backend to be as hands-off as possible. Now we get all the power of Postgres, without having to think about it”** (James Ross, Co-founder and CTO at Nodecraft)<br />
...
<figcaption>Visit nodecraft.com to explore their features</figcaption>
</figure>
...
Remember to [follow Nodecraft on X](https://x.com/nodecraft) _to see what they’re up to ✨_
