...
source:
  wpId: 11677
  wpSlug: just-launched-neon-is-now-a-kiro-power
...
<EmbedTweet url="https://twitter.com/kirodotdev/status/1996248122146599083?ref_src=twsrc%5Etfw" text="Introducing Kiro powers 👻+⚡ Your AI agents slowing down from context overload? Yeah, we've all been there. Kiro powers bundles everything (MCP servers, steering files, hooks) into neat packages that agents grab only when they actually need them for specialized dev. No… pic.twitter.com/paCGZpggu0 — Kiro (@kirodotdev) December 3, 2025" />
