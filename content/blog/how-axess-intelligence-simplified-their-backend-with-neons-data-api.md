...
source:
  wpId: 11591
  wpSlug: how-axess-intelligence-simplified-their-backend-with-neons-data-api
...
> **“We didn’t want to spend unnecessary time writing CRUD logic or maintaining a backend. We just connected Better Auth and the Data API and started building. The best part: every Neon branch gets its own Data API URL”**<br /><br />_Mouaz Anan, Engineer at [Axess Intelligence](https://axessintelligence.com)_
