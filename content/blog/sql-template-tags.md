...
> Note: this pattern is used by several Postgres clients/query builders (e.g. [Kysely](https://kysely-org.github.io/kysely-apidoc/interfaces/Sql.html), [Postgres.js](https://www.npmjs.com/package/postgres), and more) and is safe to use.
