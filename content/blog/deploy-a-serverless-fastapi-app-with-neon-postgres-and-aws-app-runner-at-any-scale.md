...
![Image](https://cdn.neonapi.io/public/images/pages/blog/deploy-a-serverless-fastapi-app-with-neon-postgres-and-aws-app-runner-at-any-scale/neon-fastapi-1024x576-1c9d4886.jpg)
...
Create a ** *s*\_\*\***ettings.py** \_ file in the ** _fastapi_neon_ ** directory alongside ** _main.py_ **. This will reference the `DATABASE_URL` environment variable. During local development, this value will be populated from an \_ **.env\*\* \_ file.
...
Create a ** _.env_ ** file in the root of your project and add the `DATABASE_URL` variable:
...
**Note: Do not commit the _.env_ file to source control. Add _.env_ to the _.gitignore_ file to prevent this file from being committed and pushed. This environment variable in this file will only be used during local development.**
...
](https://cdn.neonapi.io/public/images/pages/blog/deploy-a-serverless-fastapi-app-with-neon-postgres-and-aws-app-runner-at-any-scale/get-started-with-neon-1024x789-d8b0c6a9.png)
...
Set this value as your `DATABASE_URL` in the ** _.env_ ** file. Now, test the application by running the following to start the app server locally:
...
3. Update the ** _apprunner.yaml_ ** secret value with the SSM parameter ARN to inject the database connection string into the runtime environment
...
In your project directory, create an ** _apprunner.yaml_ ** configuration file with the following structure.
...
! [SSM Parameter Store - Copy parameter ARN
](https://cdn.neonapi.io/public/images/pages/blog/deploy-a-serverless-fastapi-app-with-neon-postgres-and-aws-app-runner-at-any-scale/ssm-copy-arn-1024x770-e26a0b1a.png)

Now, replace the placeholder (`<replace-with-param-arn>`)value in ** _apprunner.yaml_ ** in **secrets** > **value-from** with this ARN.
...
Confirm that `.env*` is included in the ** _.gitignore_** _file_ in the root of the project.
...
<br />Commit and push the code to a repo in GitHub or BitBucket. Remember, **do not commit the _.env_ file**.
...
! [AWS IAM - Create inline policy
](https://cdn.neonapi.io/public/images/pages/blog/deploy-a-serverless-fastapi-app-with-neon-postgres-and-aws-app-runner-at-any-scale/create-inline-policy-1024x205-918ea04b.png)
