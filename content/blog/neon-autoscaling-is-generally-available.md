...
source:
  wpId: 6827
  wpSlug: neon-autoscaling-is-generally-available
...
<figcaption>Initial sketch for autoscaling, conceived during a 2022 hackathon. The final implementation ended up needing a bit more code than what’s here 🙂</figcaption>
</figure>
...
<figcaption>The current architecture for Neon autoscaling</figcaption>
</figure>
...
<figcaption>A graph illustrating real autoscaling events across a fleet of Neon databases. Each line is a single endpoint, with a height equal to provisioned compute units.</figcaption>
</figure>
...
<figcaption>This figure represents two common load patterns: a variable CPU load that peaks in the evening and dips in the morning, and a bursty load pattern with large spikes in usage. This doesn’t matter to your compute bill though – you’ll pay for allocated compute 24/7.</figcaption>
</figure>
...
<figcaption>In Neon, your compute resources dynamically scale to match load, without any manual work needed from you. You’re only billed for the CPU/memory your application actually needs.</figcaption>
</figure>
...
<figcaption>To configure autoscaling, click on “Enable autoscaling” and select your min/max compute size</figcaption>
</figure>
