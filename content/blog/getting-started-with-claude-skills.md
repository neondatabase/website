...
source:
  wpId: 11374
  wpSlug: getting-started-with-claude-skills
  exportedAt: '2026-03-20T13:31:00.745Z'
---

![Image](https://cdn.neonapi.io/public/images/pages/blog/getting-started-with-claude-skills/neon-claude-skills-1-1024x576-f9433ba7.jpg)
...
| ----------------------------------------------------------------------------------------------------------------- | ----------- | ---------- | --------------- | ------------------------- |
| API integration                                                                                                   |             | ✅         |                 |                           |
| Best practices / Global rules<br />_ – Always use absolute imports _<br />_ – Use functional components_          |             |            |                 | ✅                        |
