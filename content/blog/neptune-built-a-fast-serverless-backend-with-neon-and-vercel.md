...
source:
  wpId: 10523
  wpSlug: neptune-built-a-fast-serverless-backend-with-neon-and-vercel
...
> _“The migration from Google Cloud SQL to Neon took maybe an hour total. It was a PSQL dump and restore. It was smooth and fast, with zero downtime.” – Andy Bonventre CTO at Neptune_
...
> _“We wanted to move as fast and as safely as possible—and Neon’s branching model for Postgres lets us do that. It’s just like working with Git: each developer gets their own branch, tests it, and we never have to worry about coordinating test data or stepping on each other’s toes.” – Andy Bonventre CTO at Neptune_<br />
