...
source:
  wpId: 3185
  wpSlug: semantic-search
  exportedAt: '2026-03-20T13:31:00.745Z'
---

![Image](https://cdn.neonapi.io/public/images/pages/blog/semantic-search/image-6-1024x576-33ca9bde.png)
...
## How the app works (#h.bi47o1a7kerg)
...
### What are vector embeddings? (#h.b30hssslbcq4)
...
### Generating vector embeddings using OpenAI (#h.efuw9yx1n2d1)
...
> The `text-embedding-ada-002` has an output dimension of 1536. This means that the embedding array included in the response will have a size of 1536. There are other embedding models out there that you can use. However, keep in mind that when comparing the distance between two vectors, they must be of similar length.
