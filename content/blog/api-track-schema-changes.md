...
source:
  wpId: 8155
  wpSlug: api-track-schema-changes
  exportedAt: '2026-03-20T13:31:00.745Z'
---

![Image](https://cdn.neonapi.io/public/images/pages/blog/api-track-schema-changes/neon-api-1-1024x576-78a92fa9.jpg)
...
- **`base_timestamp`** _(_ optional): the point in time on the base branch
