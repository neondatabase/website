...
## What makes this a “secure” project management system? (#what-makes-this-a-secure-project-management-system)

Data security is considered throughout this guide by using the following techniques:

### Clerk and the Next.js middleware (#clerk-and-the-next-js-middleware)
...
## Configure /app as a protected route with Clerk (#configure-app-as-a-protected-route-with-clerk)
...
### Editing and deleting tasks (#editing-and-deleting-tasks)
...
### Editing and deleting projects (#editing-and-deleting-projects)
