...
cover:
  image: >-
    https://cdn.neonapi.io/public/images/pages/blog/velocity-future-on-call/cover.jpg
  alt: null
isFeatured: true
seo:
...
source:
  wpId: 9016
  wpSlug: velocity-future-on-call
  exportedAt: '2026-03-20T13:31:00.745Z'
---

> **“We used RDS before, but the cost and manual effort of scaling it up and down was a pain. I also wanted one database solution across clouds—and Neon gave us that”** ([Tal Kain](https://x.com/talkain), Founder and CEO at [Velocity](https://velocity.tech/))
...
<figure>
<img src="https://cdn.neonapi.io/public/images/pages/blog/velocity-future-on-call/screenshot-2025-04-01-at-72742percente2percent80percentafam-722x1024-03e816e4.png" alt="Image" />
<figcaption>Visit velocity.tech for more</figcaption>
</figure>
...
> **“We use Neon branching in our development process to find issues, test migrations, and experiment safely. We create dev branches, test changes, and delete them when we’re done. It makes development faster and cleaner”** ([Tal Kain](https://x.com/talkain), Founder and CEO at [Velocity](https://velocity.tech/))
...
> **“Neon’s support team feels like an extension of our own. When we had a scaling issue in production, they solved it in minutes. That kind of support makes a huge difference.”** ([Tal Kain](https://x.com/talkain), Founder and CEO at [Velocity](https://velocity.tech/))
...
> **“We’ve started using pgvector on Neon for embeddings, and so far, performance has been great. We tried other solutions that couldn’t scale with us, but Neon handled it smoothly”** ([Tal Kain](https://x.com/talkain), Founder and CEO at [Velocity](https://velocity.tech/))

### Observability without the headaches

> **“With Neon, we can see exactly how connections behave and diagnose issues quickly. It’s been great to test and optimize performance as we grow”** ([Tal Kain](https://x.com/talkain), Founder and CEO at [Velocity](https://velocity.tech/))
