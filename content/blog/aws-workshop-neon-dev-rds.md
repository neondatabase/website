...
source:
  wpId: 8305
  wpSlug: aws-workshop-neon-dev-rds
...
<source src="https://cdn.neonapi.io/public/videos/pages/blog/aws-workshop-neon-dev-rds/aws-workshop-1-50fce327.mp4" />
</video>
...
> **“Neon’s branching paradigm has been great for us. It lets us create isolated environments without having to move huge amounts of data around. This has lightened the load on our ops team, now it’s effortless to spin up entire environments.”** _(Jonathan Reyes, Principal Engineer at [Dispatch](https://www.dispatchit.com))_
...
> **“We are using the Neon Twin workflow. We just install the GitHub action and it takes care of the rest. Developers may not know how to dump and restore well, but they know how to run a GitHub Action. It’s amazing”** _(Alex Co, Head of Platform Engineering at [Mindvalley](https://www.mindvalley.com))_
