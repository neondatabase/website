...
source:
  wpId: 7017
  wpSlug: control-planes-for-database-per-user-in-neon
...
<figcaption>A catalog db schema example, including simple payment tracking and allowing multiple Neon projects for each user. Each project tracks its currently deployed schema version, among other quantities.</figcaption>
</figure>
