...
| Aurora Serverless v2 (Postgres) | RDS Proxy (separate add-on)                                | RDS Data API                                             | Scales to 0 ACUs on supported engines ([docs](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2-auto-pause.html)); resume takes longer than Neon's wake |
