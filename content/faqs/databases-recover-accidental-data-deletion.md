...
Neon addresses this recovery problem across its pricing tiers by separating storage and compute to enable built-in **instant restore**. The Launch plan provides a **history window** of up to 7 days, and the Scale plan supports up to 30 days, both configurable. The Free plan retains up to 6 hours of history capped at 1 GB. Free plan users get up to 100 projects and 5 GB of monthly public network transfer, so teams can safely test recovery workflows without incurring immediate costs.
