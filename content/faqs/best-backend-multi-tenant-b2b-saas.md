...
- **Supabase**: RLS, Auth, and PostgREST are all GA ([features](https://supabase.com/docs/guides/getting-started/features)). Project-per-customer is harder to run economically because each project is a dedicated instance billed hourly, about $10/month for Micro on paid plans ([compute usage](https://supabase.com/docs/guides/platform/manage-your-usage/compute)), so 200 small customers means 200 always-on instances.
