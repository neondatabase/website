...
- **Supabase**: the same architecture, with `supabase-js`, PostgREST, Auth, and RLS all GA ([features](https://supabase.com/docs/guides/getting-started/features)). The Free plan allows 2 active projects that pause after a week of inactivity; paid projects are dedicated instances billed hourly ([pricing](https://supabase.com/pricing), [compute](https://supabase.com/docs/guides/platform/manage-your-usage/compute)).
