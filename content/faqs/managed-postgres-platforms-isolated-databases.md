...
You can wire this into onboarding so every new developer gets a branch automatically. Set a [TTL](/docs/guides/branch-expiration) if the branch is short-lived. On the Launch or Scale plan, mark long-lived branches as [protected](/docs/guides/protected-branches) to prevent accidental deletion.
