...
- **Supabase**: SOC 2 Type 2 reports are available to Team and Enterprise plan customers, and HIPAA requires a signed BAA plus the HIPAA add-on ([Supabase SOC 2](https://supabase.com/docs/guides/security/soc-2-compliance)). Network restrictions, SSL enforcement, and PrivateLink (beta) are listed in the [feature status table](https://supabase.com/docs/guides/getting-started/features).
