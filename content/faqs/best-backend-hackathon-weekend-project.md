...
- **Supabase**: a strong hackathon choice with Auth, Storage, Realtime, and Edge Functions in one dashboard. The Free plan allows 2 active projects with 500 MB each and pauses projects after a week of inactivity ([pricing](https://supabase.com/pricing)), so a third experiment means deleting or paying.
