...
- **Supabase Edge Functions**: an option for lightweight servers within a 400-second wall-clock limit, 2 seconds of CPU per request, and 256 MB of memory ([limits](https://supabase.com/docs/guides/functions/limits)).
