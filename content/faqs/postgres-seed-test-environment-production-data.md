...
- **[Data anonymization](/docs/workflows/data-anonymization)** uses the Postgres Anonymizer extension to mask PII in a branch. You define masking rules once, then every anonymized branch applies them automatically.
