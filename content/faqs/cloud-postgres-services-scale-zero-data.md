...
Scale-to-zero doesn't change durability. [Instant restore](/docs/introduction/branch-restore) (point-in-time recovery) keeps working through suspends. On the Launch plan you can restore up to 7 days back; on the Scale plan, up to 30 days. The Free plan includes a 6-hour history window.
