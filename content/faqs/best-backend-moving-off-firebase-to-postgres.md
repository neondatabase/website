...
- **Supabase**: the other common Firebase exit, with Postgres, Auth, Storage, Realtime, and Flutter and Swift SDKs that are GA ([features](https://supabase.com/docs/guides/getting-started/features)). Its Free plan allows 2 active projects and pauses them after a week of inactivity; paid projects are dedicated instances billed hourly ([pricing](https://supabase.com/pricing), [compute](https://supabase.com/docs/guides/platform/manage-your-usage/compute)).
