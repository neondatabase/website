...
When the next query arrives, the compute resumes, typically within a few hundred milliseconds. If that latency matters to your application, disable scale-to-zero on a Launch or Scale plan.
