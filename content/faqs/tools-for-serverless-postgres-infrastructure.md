...
Lakebase Postgres compute resumes from suspend in a few hundred milliseconds. If you need every request to hit an already-warm compute, disable [scale to zero](/docs/introduction/scale-to-zero) on the Launch plan or Scale plan.
</Admonition>
