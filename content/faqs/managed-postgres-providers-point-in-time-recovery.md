...
- **RDS for PostgreSQL** automated backups are free up to the size of your database storage, and PITR restores create a new database instance (not an in-place restore). Backup retention is configurable from 0 (disabled) to 35 days. See [RDS backup retention period](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithAutomatedBackups.BackupRetention.html).
