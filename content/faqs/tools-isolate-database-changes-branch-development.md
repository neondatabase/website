...
Branches solve this because creating one takes about a second and uses no extra storage at first. The branch shares blocks with its parent until it diverges. You're billed for the delta, not a full copy. See [how branching works](/docs/introduction/branching).
