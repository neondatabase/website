...
If you want to test a migration against a real copy of your production data without spinning up new compute that costs the same as your primary, Lakebase Postgres branching and Aurora cloning are the two options that fit. Neon adds usage-based pricing for branch compute and a documented per-PR workflow on top.
