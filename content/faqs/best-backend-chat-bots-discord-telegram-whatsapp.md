...
- **Supabase Edge Functions**: a common home for webhook bots, with a 400-second wall-clock limit on paid plans, 2 seconds of CPU per request, and 256 MB of memory ([limits](https://supabase.com/docs/guides/functions/limits)). Each Supabase project is a dedicated Postgres instance billed hourly ([compute](https://supabase.com/docs/guides/platform/manage-your-usage/compute)).
