...
A Lakebase Postgres branch is closest to the Aurora clone model: copy-on-write, instantly available, with separate compute. Branching is included on every Neon plan.
