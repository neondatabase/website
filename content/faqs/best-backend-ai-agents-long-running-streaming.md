...
- **Supabase Edge Functions**: 256 MB of memory, 2 seconds of CPU time per request, and a 400-second wall-clock limit on paid plans (150 seconds on Free) ([Supabase limits](https://supabase.com/docs/guides/functions/limits)). The CPU budget is the tight constraint for multi-step agents.
