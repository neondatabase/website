...
| AWS RDS / Aurora | Aurora only: 4 ACUs and 2 clusters on the AWS Free plan ([docs](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-free-tier.html)). RDS runs on sign-up credits | Instances run 24/7 unless stopped manually or paused at 0 ACUs                                                                   | 1 GB per Aurora cluster; otherwise pay-per-GB                                           |
