...
- [Vector DB per Tenant](https://db-per-tenant.up.railway.app/) - Fast, secure chat-with-pdf app showing how to provision a dedicated vector database instance for each user on [Railway](https://railway.com) and Neon. [Source](https://github.com/crialabs/db-per-tenant) created by [Mahmoud](https://x.com/thisismahmoud_)
...
Is your company using Neon to ship faster experiences faster? [Let us know in this GitHub Discussion](https://github.com/crialabs/neon/discussions/10827) and we'll add you to the list!
...
- **Faster Branching** - Our custom storage engine enables data + schema clones for databases of any size in less than a second. [Try it in a web demo](https://neon-demos-branching.vercel.app/) [View Source](https://github.com/crialabs/branching-demo)
...
You can read about the [architectural decisions for Neon](/blog/architecture-decisions-in-neon) and even see [all of our engineering RFCs](https://github.com/crialabs/neon/tree/main/docs/rfcs), too. If you're interested [we're hiring](/careers).
