...
subtitle: Learn how to manage database schema changes in Go applications using Neon's Lakebase Postgres
author: bobbyiliev
...
Database migrations are essential for managing schema evolution in applications as they grow and change over time. When working with Go applications and Neon's Lakebase Postgres, implementing a good migration strategy allows you to have smooth deployments and database changes without disruption.
...
To run migrations against your Lakebase Postgres database, you'll need to construct a proper connection string. Neon provides a secure, TLS-enabled connection:
...
With your migration files created and your connection string ready, you can now run migrations against your Lakebase Postgres database.
