...
The tables will be created in your Lakebase Postgres database when the application starts, thanks to the `Base.metadata.create_all(bind=engine)` line in the `main.py` file.
