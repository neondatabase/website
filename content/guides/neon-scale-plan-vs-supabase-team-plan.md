...
| Database storage | $0.35 per GB-month; no hard per-branch size limit (soft limit 16 TB, more on request)                    | 8 GB disk included per project, then $0.125 per GB; disks up to 60 TB                                               |
