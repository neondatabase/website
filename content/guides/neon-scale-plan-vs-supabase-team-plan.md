...
Pricing and feature claims in this guide were verified against the live Neon and Supabase documentation on August 13, 2026, the headline plan and pricing figures were re-checked on August 21, 2026, and Neon Functions and Object Storage pricing was updated on September 23, 2026. Confirm the [Neon pricing](/pricing) and [Supabase pricing](https://supabase.com/pricing) pages before making a decision.
</Admonition>
...
| Database storage | Unlimited storage at $0.35 per GB-month; no hard per-branch size limit                                           | 8 GB disk included per project, then $0.125 per GB; disks up to 60 TB                                               |
...
| Functions        | $0.12 active / $0.03 waiting per Capacity-Hour, plus $0.60 per million invocations                               | 2M Edge Function invocations included, then $2 per million                                                          |
| File storage     | Object Storage at $0.023 per GB-month                                                                            | 100 GB included, then $0.0213 per GB                                                                                |
...
| AI Gateway       | Models from multiple providers via one credential; inference billed from prepaid credits at provider list prices | Not currently offered                                                                                               |
...
| Support          | Standard included; additional options for higher-volume customers                                                | Priority email support and SLAs                                                                                     |
...
The Neon Scale plan's certifications cover SOC 2, SOC 3, ISO 27001, ISO 27701, GDPR, and CCPA, with [HIPAA](/docs/security/hipaa) at additional charge. Access controls include IP Allow and [Private Networking](/docs/guides/neon-private-networking) over AWS PrivateLink, and metrics and Postgres logs export to Datadog or any OTel-compatible platform ([source](/docs/introduction/plans#compliance-and-security)). An uptime SLA is included; support is Standard, with additional support options for higher-volume customers ([source](/docs/introduction/plans#support)).
...
5. Service usage: Realtime messages and peak concurrent connections, function invocations, and file storage on Supabase's meters; on Neon, Functions bill per Capacity-Hour and per million invocations, and Object Storage bills per GB-month ([source](/docs/introduction/plans#functions)).
...
| Functions (5M calls)   | $3 (5M invocations at $0.60/M, plus Capacity-Hours of runtime)  | $6 (3M over the included 2M)                       |
| **Total**              | **~$730/month** plus function runtime                           | **~$1,150/month**                                  |
...
| Functions (5M calls)   | $3 (5M invocations at $0.60/M, plus Capacity-Hours of runtime)   | $6 (3M over the included 2M)                         |
| **Total**              | **~$1,795/month** plus function runtime                          | **~$1,875/month**                                    |
...
<DetailIconCards>
<a href="/guides/neon-vs-supabase" title="Backend comparison" description="Compare the two backends service by service" icon="database">Neon vs Supabase overview</a>
