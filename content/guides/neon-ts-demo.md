...
- **Provision Neon services** like Postgres, [Managed BetterAuth](/docs/auth/overview), and the [Data API](/docs/data-api/overview) directly from your codebase.
...
- **Services**: Enables Postgres, Managed BetterAuth and the Neon Data API for your project.
...
$ neon config plan
  ...
  Utilized services: Postgres, Managed BetterAuth, Data API
```
  ...
  return (
    <main className="p-8 font-sans">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 border rounded bg-gray-50 dark:bg-gray-900">
          <h2 className="font-semibold text-green-600">Managed BetterAuth</h2>
