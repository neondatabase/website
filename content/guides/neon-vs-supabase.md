...
| Storage       | S3-compatible object storage with a namespace per branch; scales independently from your Postgres database ([source](/docs/storage/overview)) | S3-compatible storage with CDN and image optimization ([source](https://supabase.com/docs/guides/storage))                                                            |
