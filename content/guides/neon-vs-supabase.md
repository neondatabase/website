...
| AI Gateway                | One credential for models from multiple providers (paid plans); inference not billed yet, then provider list prices ([source](/docs/ai-gateway/overview))      | Not currently offered                                                                                                                                                |
...
- **Neon**: [AI Gateway](/docs/ai-gateway/overview) (paid plans) routes inference to models from Anthropic, OpenAI, Google, Meta, Databricks, and Alibaba through a single Neon credential, not billed yet and at provider list prices with no markup once billing begins ([source](/docs/introduction/plans#ai-gateway)).
