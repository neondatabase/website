...
Neon is a fully managed, open source, serverless PostgreSQL built for the cloud. Neon separates storage and compute to offer modern developer features such as database branching, scale to zero, and bottomless storage.


[Read more](https://neon.tech/) about about Neon, follow a guide to get started from your preferred application or framework, or explore the docs to learn more about connecting, importing data, and features such as database branching and the Neon API.

## New to Neon?

The [Neon quickstart guide](https://neon.tech/) will get you up and running with Neon in just a few minutes. You will learn how to:
...
<img src="/images/technology-logos/entity-logo.svg" width="36" height="36" alt="Entity Framework" href="/docs/guides/elixir-ecto" title="Schema migration with Neon and Entity Framework" />
