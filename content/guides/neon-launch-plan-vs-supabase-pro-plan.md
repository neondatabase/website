...
| AI Gateway       | Models from multiple providers via one credential, at provider list prices       | Not currently offered                                                                                              |
| Network transfer | 500 GB per project included, then $0.10 per GB                                   | 250 GB included, then $0.09 per GB                                                                                 |
| Branches         | 10 included per project; extra branches $1.50 per branch-month, prorated hourly  | No fixed fee; a branch is an environment billed for its usage, starting at $0.01344 per hour on Micro compute      |
