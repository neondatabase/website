...
3.  A dialog will appear prompting you to either select an existing credential or create a new one. Click "Create new credential".
    ...
    <Admonition type="tip">
    You can get your Lakebase Postgres database connection details from the Neon console. Learn more: [Connect from any application](/docs/connect/connect-from-any-app)
    </Admonition>

4.  Fill in your Lakebase Postgres database details:
    - **Host:** Your Neon host
    - **Database:** Your Lakebase Postgres database name
    - **User:** Your Lakebase Postgres database user
    - **Password:** Your Lakebase Postgres database password
    - **SSL:** Set to "Require".
5.  Click "Save".
