---
title: Using pgAdmin4 with hosted Postgres
...
To get started, go to the [Neon Console](https://console.neon.tech/app/projects) and create a project with a name of your choice. Then click **Connect** to view your connection string.
...
- `?sslmode=require&channel_binding=require` optional query parameters that enforce the [SSL](https://www.cloudflare.com/en-gb/learning/ssl/what-is-ssl/) mode and channel binding while connecting to the Postgres instance.

You'll use these connection string components in the next section to connect pgAdmin4 to your database.
