...
function buildTests() {
  ...
  add('404 handling', fake404Path, 'accept-md', [
    ...
    (r) => expectBodyContains(r.body, '/docs/llms.txt'),
    (r) => expectBodyContains(r.body, '/docs/cli.md'),
  ...
  add(
    ...
    [(r) => expectStatus(r.status, 200), (r) => expectBodyNotEmpty(r.body)],
    {
      ...
      note: 'generated by generate-api-ref.mjs — must contain endpoint listing',
    }
  );
  ...
  add(
    ...
    [(r) => expectStatus(r.status, 200), (r) => expectBodyNotEmpty(r.body)],
    {
      spotCheck: (r) => expectBodyContains(r.body, 'neonctl', true),
      note: 'Neon CLI reference markdown',
    }
  );
