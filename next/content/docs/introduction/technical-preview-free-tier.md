...
- 100 compute hours per month (total for all compute endpoints)
- A point-in-time restore window of 7 days of _reasonable usage_

You are always able to connect the compute endpoint associated with the root branch of your Neon project, regardless of the compute hour limit.
