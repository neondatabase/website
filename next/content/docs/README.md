...
3. `slug` is generated based on the folder structure and file names inside this folder. In order to see page `slug`, you can [start the project](../../README.md#run-the-website) and build project with `npm run build` command that will display all docs pages.
