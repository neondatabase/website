---
description: 'DEPRECATED and no longer maintained. Generate changelog from all repos using parallel extraction agents.'
---

# Changelog Triage Command (Agent-Based)

> **Deprecated.** This command still works but is no longer maintained.
