...
const TemplatesPage = () => (
  <Layout headerWithBorder burgerWithoutBorder isHeaderSticky hasThemesSupport>
    <div className="safe-paddings flex flex-1 flex-col dark:bg-black-pure dark:text-white lg:block">
      <Container
        className="grid w-full flex-1 grid-cols-5 pb-[104px] pt-12 xl:gap-x-7 xl:pb-24 lg:block lg:gap-x-5 lg:pt-11 lg:pt-9 md:pt-10 sm:pt-8"
        size="960"
      >
        <div className="col-span-4 col-start-1 max-w-[703px]">
          <h1 className="font-title text-4xl font-medium leading-none tracking-extra-tight xl:text-[36px] lg:text-[32px]">
            Find your Template
          </h1>
        ...
        <div className="col-span-5 col-start-1 mt-14 grid grid-cols-5 xl:mt-12 lg:mt-11 lg:flex lg:flex-col">
          <Content />
        </div>
      </Container>
    </div>
