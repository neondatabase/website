...
const EnterprisePage = () => (
  <Layout headerClassName="absolute! bg-transparent!">
    <Hero />
    <Logos className="mt-[102px] md:mt-[68px] lg:mt-[76px] xl:mt-[86px]" logos={logos} />
    <TestimonialNew
    ...
    <TestimonialNew
      className="mt-[126px] md:mt-[58px] lg:mt-[70px] xl:mt-[106px]"
    ...
    <TestimonialNew
      className="mt-[130px] md:mt-[62px] lg:mt-[48px] xl:mt-[106px]"
