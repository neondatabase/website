...
const DemoPage = () => (
  <Layout>
    ...
    <CTAWithElephant
      ...
      description="The fully managed multi-cloud backend with a generous free tier. We separated storage and compute to offer autoscaling, branching, and bottomless storage."
      buttonText="Sign Up"
