...
export default async function BlogPage() {
  ...
  return (
    <>
      ...
      <SubscribeForm
        className="mt:pt-7 -mx-10 rounded-xl bg-black-new p-[70px] pr-28 2xl:mx-0 2xl:px-10 2xl:pb-16 2xl:pt-10 lt:px-11 lt:py-[70px] lt:pt-10 lg:pb-16 md:px-5 md:pb-12 md:pt-7"
        size="md"
      />
