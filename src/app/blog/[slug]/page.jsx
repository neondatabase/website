...
const BlogPage = async ({ params }) => {
  ...
  return (
    <Layout headerTheme="gray-8" footerTheme="gray-8" isHeaderSticky>
      <div className="bg-gray-new-8 pt-20">
        <article className="mx-auto grid max-w-[1472px] grid-cols-12 gap-x-8 text-white xl:max-w-[936px] xl:pt-16 lg:max-w-none lg:px-6 lg:pt-12 md:gap-x-0 md:px-4 md:pt-6">
          <Hero
