...
/**
 * Creates an array of group indices and staggered delays based on duration, text string, and easing function.
 * @param {number} duration - Total duration in seconds
 * @param {string} textString - The text to break into groups
 * @returns {{ groupIndices: Array<number>, staggeredDelays: Array<number> }} Object with group indices array and staggered delays array
 */
const useTextStaggeredAnimation = ({ duration, textString }) => {
  ...
  return { groupIndices, staggeredDelays };
};

export default useTextStaggeredAnimation;
