...
export default {
  ...
  claimablePostgres: {
    title: 'Claimable Postgres for agents — Neon',
    description:
      'Let agents provision temporary Lakebase Postgres, Data API, and Managed Better Auth before a human creates a Neon account.',
    pathname: LINKS.claimablePostgres,
  },
  cli: {
