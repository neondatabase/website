...
export const STATIC_MD_PATHS = [
  ...
  '/docs/ai/skills/neon-auth/references/self-managed.md',
  ...
  '/docs/ai/skills/neon/references/parse-env.md',
  ...
  '/prompts/durable-workflow-on-neon-functions-prompt.md',
  ...
  '/prompts/sentry-neon-functions-prompt.md',
