...
const InkeepSearch = ({ className = null, handleClick, isNotFoundPage = false }) => (
  <div className={clsx('relative flex items-center justify-between', className)}>
    <button
      className={clsx(
        ...
        isNotFoundPage
          ...
          : 'h-8 w-[264px] rounded-lg border p-1 pl-2.5 lg:w-auto lg:border-none lg:bg-transparent! lg:p-0 xl:w-60'
      )}
      type="button"
    ...
    >
      ...
      <span className="rounded-sm border border-gray-new-90 p-[3px] lg:hidden dark:border-gray-new-20">
