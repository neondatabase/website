...
const TopBar = () => (
  <Link
    className="safe-paddings relative z-40 flex h-9 w-full items-center justify-center overflow-hidden bg-[#0B0C0F] px-4 py-2.5 leading-none transition-colors duration-200 hover:bg-gray-new-8"
