...
const TopBar = ({ isDarkTheme }) => (
  <Link
    ...
    to="https://neon.tech/blog/neon-is-now-available-as-an-azure-native-integration"
    onClick={() => {
  ...
  >
    ...
    >
      Neon is now available as an Azure Native Integration: You can deploy Neon databases directly from the Azure Portal
    </span>
    <ChevronIcon
      className={clsx(
