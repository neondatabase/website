  ...
  return (
    <section className="bg-black-pure pt-16 safe-paddings">
      <Container className="grid grid-cols-12 items-center gap-4" size="md">
        <div className="z-10 col-span-4 col-start-2 mb-24 lg:mb-12 xl:col-span-5 xl:col-start-1 md:col-span-full">
          <Heading
          ...
          <AnimatedButton
            className="mt-8 inline-flex px-14! py-5! text-lg! tracking-tight hover:bg-[#00FFAA] lg:mt-6 xl:px-11! xl:py-[17px]! md:mx-auto md:flex md:w-48"
            theme="primary"
        ...
        >
          ...
          <div ref={setRiveRef}>
            {isContentInView ? (
              <RiveComponent
                className="absolute top-[184px] left-1/2 h-[140px] w-[89px] -translate-x-1/2 2xl:top-[142px] 2xl:h-[140px] 2xl:w-[74px] lg:hidden xl:top-[124px] xl:h-[78px] xl:w-[58px]"
                width={74}
                height={140}
                aria-hidden
              />
