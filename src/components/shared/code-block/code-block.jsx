...
const CodeBlock = ({ className, children, showLineNumbers, ...otherProps }) => {
  ...
  return (
    <div className={clsx('group relative', className)} {...otherProps}>
      ...
      <button
        className="invisible absolute top-2 right-2 rounded border border-gray-6 bg-white p-1.5 opacity-0 transition-[background-color,opacity,visibility] duration-200 group-hover:visible group-hover:opacity-100"
        type="button"
        disabled={isCopied}
