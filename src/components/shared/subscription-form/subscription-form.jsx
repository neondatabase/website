...
const SubscriptionForm = ({
  ...
  return (
    <form
      className={clsx(
        'relative ml-[14px] before:absolute before:h-full before:w-full before:rounded-full before:bg-secondary-2 2xl:ml-2.5 lg:mx-auto lg:max-w-[584px] xl:ml-2 xl:before:-bottom-2 xl:before:-left-2 md:before:w-[calc(100%+8px)]',
        className,
