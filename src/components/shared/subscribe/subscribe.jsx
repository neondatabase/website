    ...
    <Container className="flex items-center justify-between">
      ...
      <div className="max-w-[710px]">
        ...
        <div className="relative mt-10 ml-[14px] before:absolute before:-bottom-3.5 before:-left-3.5 before:w-full before:h-full before:bg-secondary-2 before:rounded-full">
          <input
            className="relative block w-[696px] h-24 mt-8 text-black bg-white border-4 border-black rounded-full outline-none t-2xl pl-7 pr-[218px]"
            type="email"
        ...
        <div className="flex items-center space-x-[38px] mt-[94px]">
          ...
          <ul className="flex space-x-[26px]">
            {links.map(({ icon: Icon, to }, index) => (
              <li key={index}>
                <Link
                  className="relative flex items-center justify-center bg-white border-black border-4 rounded-full w-[72px] h-[72px] before:absolute before:-bottom-2.5 before:-left-2.5 before:w-[72px] before:h-[72px] before:bg-secondary-5 before:rounded-full before:z-[-1]"
                  to={to}
                >
                  <Icon />
                </Link>
