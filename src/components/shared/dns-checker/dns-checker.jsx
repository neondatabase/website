...
||||||| parent of 1d8081f68 (style: update DNS checker component styling to match Request extension component)
=======
'use client';
...
const DNSChecker = () => {
  ...
  const renderResults = () => {
    ...
    if (localDNS.success && cloudflare.success) {
      return (
        <div className="mt-4 rounded-lg bg-gray-new-15 p-4">
    ...
    if (!localDNS.success && cloudflare.success) {
      return (
        <div className="mt-4 rounded-lg bg-gray-new-15 p-4">
          ...
          <p className="mt-2 text-sm text-gray-new-60">
            Please refer to our{' '}
            <a
              href="https://neon.tech/docs/connect/connection-errors#dns-resolution-issues"
              className="text-primary-1 hover:underline"
    ...
    if (!localDNS.success && !cloudflare.success) {
      return (
        <div className="mt-4 rounded-lg bg-gray-new-15 p-4">
          <p className="font-medium text-white">DNS resolution failed.</p>
          <p className="mt-2 text-sm text-gray-new-60">
            Please verify your hostname or refer to our{' '}
            <a
              href="https://neon.tech/docs/connect/connection-errors#dns-resolution-issues"
    ...
    if (localDNS.success && !cloudflare.success) {
      return (
        <div className="mt-4 rounded-lg bg-gray-new-15 p-4">
          <p className="font-medium text-white">Unexpected DNS resolution issue.</p>
          <p className="mt-2 text-sm text-gray-new-60">
            Please verify your hostname or refer to our{' '}
            <a
              href="https://neon.tech/docs/connect/connection-errors#dns-resolution-issues"
  ...
  return (
    <figure
      className={clsx(
        'doc-cta not-prose my-6 rounded-[10px] border border-gray-new-15 bg-gray-new-10 p-6'
      )}
    >
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <div className="flex flex-col space-y-4">
            <input
              ...
              value={hostname}
              className={clsx(
                'h-10 w-full rounded border-none bg-gray-new-15 px-4 py-3 text-sm',
                !isValidFormat && 'ring-1 ring-secondary-1'
              )}
              onChange={handleInputChange}
            />
            <Button
              ...
              theme="primary"
              size="md-new"
              className="w-full px-6 py-3 font-semibold leading-none"
              disabled={isChecking || !hostname}
            >
              {isChecking ? (
                <>
...
export default DNSChecker;
>>>>>>> 1d8081f68 (style: update DNS checker component styling to match Request extension component)
