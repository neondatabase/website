...
const Hits = connectHits(({ hits, showAll, isNotFoundPage }) =>
  hits?.length ? (
    <ul className="mt-4 divide-y divide-gray-6 px-2.5">
    ...
    <div
      className={clsx(
        ...
        isNotFoundPage
          ...
          : 'rounded-b border border-gray-6 '
      )}
    >
      <div
        className={clsx(
      ...
      <div
        className={clsx(
          'mt-2.5 flex justify-between bg-gray-6 p-2.5',
      ...
      >
        ...
        <Link
          className="ml-auto flex items-center space-x-2 text-xs text-gray-6"
