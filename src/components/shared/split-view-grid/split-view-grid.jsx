...
const SplitViewGrid = ({
  ...
  <section className={clsx('benefits safe-paddings', className)}>
    <Container className="grid-gap-x grid grid-cols-12" size="medium">
      <div className="col-span-10 col-start-2 grid grid-cols-10 gap-x-10 rounded-2xl bg-black-new py-12 xl:col-span-full xl:col-start-1 xl:grid-cols-12 xl:items-center xl:gap-x-6 xl:py-8 lg:gap-x-4 lg:pb-10 lg:pt-9 md:py-8">
