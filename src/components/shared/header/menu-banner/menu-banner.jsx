...
const MenuBanner = ({ linkProps: { className, ...linkProps } = {} }) => (
  <Link
    className={clsx(
      'group relative flex h-[340px] w-[320px] items-end! overflow-hidden border border-gray-new-10 bg-black-pure p-6 md:h-[240px] md:w-[320px] lg:w-auto',
      className
    )}
    to={links.whyNeon}
    tagName="Menu Banner"
  ...
  >
    ...
    <div className="flex flex-col gap-y-2">
      <p className="flex items-baseline gap-x-2.5 text-2xl leading-none font-medium tracking-tighter whitespace-nowrap text-white md:text-base lg:text-lg">
        What is Neon
