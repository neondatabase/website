...
const Hero = () => (
  <section className="hero relative pt-40 safe-paddings xl:pt-36 lg:pt-12 sm:pt-8">
    <Container
      className="relative z-10 flex max-w-xl! flex-col items-start lg:max-w-[642px]!"
      size="xxs"
    >
      <h1 className="max-w-[540px] font-title text-[52px] leading-none font-medium tracking-extra-tight xl:max-w-[460px] xl:text-[48px] sm:text-[32px]">
      ...
      <Button
        className="mt-[38px] px-5! py-4! leading-none font-semibold tracking-tighter whitespace-nowrap transition-colors duration-200 xl:mt-[36px] xl:text-base! md:mt-8 sm:mt-7"
