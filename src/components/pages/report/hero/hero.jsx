...
const Hero = () => (
  <section className="hero relative pt-40 safe-paddings sm:pt-8 lg:pt-12 xl:pt-36">
    <Container
      className="relative z-10 flex max-w-xl! flex-col items-start lg:max-w-[642px]!"
      size="xxs"
    >
      <h1 className="max-w-[540px] font-title text-[52px] leading-none font-medium tracking-extra-tight sm:text-[32px] xl:max-w-[460px] xl:text-[48px]">
        Postgres failures happen. Long restores make them worse.
      </h1>
      <p className="mt-4 text-lg leading-snug tracking-extra-tight text-gray-new-80 sm:text-[14px] lg:text-base">
