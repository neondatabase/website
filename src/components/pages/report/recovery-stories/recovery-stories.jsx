...
const RecoveryStories = () => {
  ...
  return (
    <section className="recovery-stories safe-paddings mt-[155px] lg:mt-[140px] sm:mt-[126px]">
      <Container className="flex !max-w-[576px] flex-col items-start" size="xxs">
        <h2 className="relative z-10 font-title text-5xl font-medium leading-tight tracking-extra-tight lg:text-[44px] md:text-[40px] sm:text-[32px]">
        ...
        {visibleStories < DATA.length && (
          <button
            className="mt-5 flex items-center gap-x-2 text-[15px] font-medium text-white transition-colors hover:text-green-45"
            type="button"
            onClick={handleShowMore}
          >
            Show more
            <ArrowDownIcon className="" width={12} height={7} alt="" aria-hidden />
          </button>
        )}
        <Image
          className="pointer-events-none absolute -left-[115px] -top-[120px] z-[1] lg:-left-[83px] md:-left-[60px] sm:-left-[27px] sm:-top-[90px] sm:max-w-[150px]"
          src={quoteIcon}
          width={195}
          height={170}
          alt=""
