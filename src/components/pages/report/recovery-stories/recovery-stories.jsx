...
const RecoveryStories = () => {
  ...
  return (
    <section className="recovery-stories mt-[155px] safe-paddings sm:mt-[126px] xl:mt-[140px]">
      <Container className="flex max-w-xl! flex-col items-start lg:max-w-[642px]!" size="xxs">
        <h2 className="relative z-10 font-title text-5xl leading-tight font-medium tracking-extra-tight sm:text-[32px] lg:text-4xl xl:text-[44px]">
          Recovery horror stories
        </h2>
        <m.ul className="recovery-stories-list mt-11 flex flex-col gap-y-9 sm:mt-7 lg:mt-[38px] xl:mt-10 xl:gap-y-7">
        ...
        <Image
          className="pointer-events-none absolute -top-[120px] -left-[115px] z-[1] sm:-top-[90px] sm:-left-[27px] sm:max-w-[150px] lg:-left-[48px] xl:-left-[83px]"
          src={quoteIcon}
          width={195}
          height={170}
          alt=""
