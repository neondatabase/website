...
const Hero = () => (
  <section className="hero relative pt-40 safe-paddings lg:pt-12 xl:pt-[150px] md:pt-10">
    <Container className="relative z-10 flex flex-col items-center text-center" size="960">
      <h1 className="mx-auto font-title text-6xl leading-[0.9] font-medium tracking-extra-tight lg:text-5xl xl:text-[56px] md:text-4xl">
