  ...
  return (
    ...
    >
      <div className="relative z-10">
        <h2 className="my-0! font-title text-2xl leading-tight font-medium tracking-extra-tight">
          {title}
        </h2>
          ...
          <LazyMotion features={domAnimation}>
            <AnimatePresence>
              ...
              {formState === STATES.LOADING && (
                ...
                >
                  <svg
                    className="absolute top-1/2 left-1/2 h-[22px] w-[22px]"
                    width="58"
                    height="58"
                    viewBox="0 0 58 58"
                    fill="none"
          ...
          {formState === STATES.ERROR && errorMessage && (
            <span
              className={cn(
                ...
                'before:rounded-tl-sm before:border-t before:border-l before:border-secondary-1/30 before:bg-[#21191d]'
              )}
            >
