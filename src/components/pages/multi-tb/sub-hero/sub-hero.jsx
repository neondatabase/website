...
const Hero = () => (
  <section className="sub-hero relative pt-[120px] safe-paddings lg:pt-24 xl:pt-[112px] md:pt-16">
    <Container className="lg:mx-24 md:mx-auto md:max-w-[640px]" size="576">
      ...
      <h2 className="mt-[136px] font-title text-[60px] leading-none font-medium tracking-extra-tight lg:mt-[112px] lg:text-[44px] xl:mt-[128px] xl:text-[52px] md:mt-[74px] md:text-[36px]">
        Break the RDS cycle.
      </h2>
      ...
      <MegaLink
        className="my-16! lg:my-12! xl:my-14! md:my-10!"
