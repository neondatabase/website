...
const Hero = () => (
  <section className="hero relative pt-[160px] safe-paddings lg:pt-12 xl:pt-[150px] md:pt-10">
    <Container className="lg:mx-24 md:mx-auto md:max-w-[640px]" size="576" as="header">
      <h1 className="max-w-[646px] font-title text-[64px] leading-none font-medium tracking-extra-tight lg:max-w-[440px] lg:text-5xl xl:max-w-[500px] xl:text-[56px] md:max-w-full md:text-[36px]">
