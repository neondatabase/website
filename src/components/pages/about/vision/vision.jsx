...
const StatCard = ({ icon, value, description }) => (
  <div className="flex w-[212px] flex-col gap-5 lg:w-40 lg:gap-3.5 xl:w-48 xl:gap-4 md:w-full">
    <Image
      src={icon}
      alt=""
      width={32}
    ...
    <div className="flex flex-col gap-1.5 lg:gap-1">
      <span className="text-4xl leading-dense font-normal tracking-tighter text-black-pure lg:text-[28px] xl:text-[36px] md:text-2xl">
        {value}
      </span>
...
const Vision = () => (
  <SecondarySection title="Company Statistics and Vision" className="md:pb-[26px]">
    <div className="flex gap-x-[140px] lg:gap-x-12 xl:gap-x-32 md:flex-col md:gap-y-20">
      <div className="relative flex-1 before:absolute before:top-0 before:-left-8 before:h-full before:w-px before:bg-gray-new-50 xl:ml-8 md:ml-0 md:before:hidden">
        ...
        <h3 className="mt-5 max-w-[736px] text-5xl leading-dense font-normal tracking-tighter text-gray-new-40 lg:max-w-full lg:text-2xl xl:max-w-[600px] xl:text-[36px] md:mt-4 md:text-xl">
        ...
        <div className="mt-[194px] flex gap-x-24 lg:gap-x-8 xl:mt-[136px] xl:gap-x-16 md:mt-9 md:flex-col md:gap-y-7 md:pr-24">
      ...
      <div className="relative grid w-[416px] content-between before:absolute before:top-0 before:-left-8 before:h-full before:w-px before:bg-gray-new-50 lg:order-0 lg:w-[238px] xl:w-[320px] md:w-full md:gap-y-4 md:before:hidden">
        <SectionLabel icon="arrow">Our Vision</SectionLabel>

        <div className="grid gap-y-10 lg:gap-y-7 xl:gap-y-9 md:gap-y-4">
          <p className="text-xl leading-normal tracking-tighter text-black-pure lg:text-base xl:text-lg md:text-[15px]">
          ...
          <p className="text-xl leading-normal tracking-tighter text-black-pure lg:text-base xl:text-lg md:mr-8 md:text-[15px]">
