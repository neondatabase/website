...
const Hero = () => (
  <section className="hero pt-36 safe-paddings lg:pt-14 xl:pt-32 md:pt-10">
    <Container className="grid grid-cols-12 grid-gap-x lg:grid-cols-1" size="medium">
      <div className="col-span-10 col-start-2 lg:col-span-full lg:col-start-1">
        <h1 className="font-title text-6xl leading-none font-medium tracking-extra-tight sm:text-3xl lg:text-5xl xl:text-[56px] md:text-4xl">
