...
const Features = ({ title, items }) => (
  <section className="features mt-[200px] safe-paddings lg:mt-32 xl:mt-40 md:mt-24">
    <Container className="xl:px-8! md:px-5!" size="1152">
      <div className="flex gap-10 rounded-2xl lg:flex-wrap lg:gap-12 md:gap-10">
        <h2 className="min-w-[360px] font-title text-[44px] leading-none font-medium tracking-extra-tight lg:max-w-[440px] lg:text-[32px] xl:min-w-[312px] xl:text-4xl md:text-[28px]">
          {title}
        </h2>
        <ul className="grid grid-cols-2 gap-x-[26px] gap-y-11 lg:gap-10 xl:gap-x-[30px] md:grid-cols-1 md:gap-8">
