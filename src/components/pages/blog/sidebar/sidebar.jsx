...
const Sidebar = ({ categories }) => {
  ...
  return (
    <aside className="relative z-10 mt-[283px] flex w-[288px] shrink-0 flex-col gap-y-10 sm:top-[248px] lg:top-[188px] lg:mt-0 lg:mb-10 lg:min-h-fit lg:w-full xl:w-[202px] md:absolute md:top-[210px] md:right-0 md:left-0 md:mt-0 md:mb-0 lt:mt-[267px]">
