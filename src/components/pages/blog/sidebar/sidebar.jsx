...
const Sidebar = ({ categories }) => {
  ...
  return (
    <aside className="relative z-10 mt-[283px] flex w-[288px] shrink-0 flex-col gap-y-10 xl:w-[202px] lt:mt-[267px] lg:top-[188px] lg:mb-10 lg:mt-0 lg:min-h-fit lg:w-full md:absolute md:left-0 md:right-0 md:top-[210px] md:mb-0 md:mt-0 sm:top-[248px]">
