...
const Hero = () => (
  <section className="hero relative z-10 grow overflow-hidden bg-black-pure py-40 xl:pb-24 xl:pt-32 lg:py-24 md:py-20">
    <Container className="xl:max-w-5xl" size="1280">
      <div className="flex min-h-[578px] justify-between gap-16 xl:gap-10 lg:mx-auto lg:min-h-0 lg:max-w-xl lg:flex-col lg:gap-12">
        <div className="flex max-w-[544px] flex-1 flex-col lg:max-w-full">
          <SectionLabel className="mb-5 lg:mb-[18px] md:mb-4" theme="white">
            Talk to us
          </SectionLabel>
          <Heading tag="h1" size="md-new" theme="white">
            Start building faster with serverless Postgres
          </Heading>
          <div className="mt-auto flex flex-col gap-7">
            <p className="max-w-[544px] text-pretty text-lg leading-[1.5] tracking-tight text-gray-new-70 lg:max-w-full">
            ...
            <ul className="flex flex-col gap-y-5 border-t border-gray-new-20 pt-7">
              {CERTIFICATES.map(({ title, description, icon }) => (
                <li className="flex items-center gap-3" key={title}>
                  <Image src={icon} alt={title} width={36} height={36} priority />
                  <p className="flex items-center gap-1 text-lg leading-[1.5] tracking-tight text-gray-new-60 lg:text-base">
        ...
        <div className="relative w-full max-w-[576px] shrink-0 xl:max-w-[540px]">
          <ContactForm />
        </div>
      </div>
    </Container>
