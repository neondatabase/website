...
const Hero = () => (
  <section className="hero safe-paddings relative overflow-hidden pb-[198px] pt-[344px] xl:pb-[166px] xl:pt-[328px] lg:pb-[134px] lg:pt-[264px] md:pb-[94px] md:pt-[191px]">
    <Image
      className="pointer-events-none absolute left-1/2 top-0 h-auto w-[1920px] max-w-none -translate-x-1/2 object-cover xl:top-[-18px] lg:-top-3 lg:w-[1460px] md:top-[-18px] md:w-[1200px]"
      src={logoPattern}
      alt=""
      quality={85}
      priority
    ...
    <Container className="relative z-10 flex flex-col items-center text-center" size="lg">
      ...
      <h1 className="mx-auto max-w-[968px] text-[72px] font-medium leading-none tracking-tighter xl:text-[56px] lg:max-w-[700px] lg:text-[52px] md:text-4xl">
