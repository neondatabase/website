...
const Hero = () => (
  <section className="hero safe-paddings relative overflow-hidden pb-32 pt-[306px] xl:pb-24 xl:pt-[239px] lg:pb-20 lg:pt-[194px] md:pb-14 md:pt-[164px]">
    <Image
      className="pointer-events-none absolute left-1/2 top-[68px] h-auto w-[1472px] max-w-none -translate-x-1/2 object-cover xl:top-[74px] xl:w-[1040px] lg:top-7 lg:w-[1024px]"
      src={logoPattern}
      alt=""
      quality={85}
      priority
    ...
    <Container className="relative z-10 flex flex-col items-center text-center" size="lg">
      ...
      <h1 className="mx-auto max-w-[968px] text-6xl font-medium leading-none tracking-[-0.02em] xl:text-[56px] lg:max-w-[700px] lg:text-5xl md:text-4xl">
      ...
      <AnimatedButton
        className="relative mt-9 px-[34px] py-[17px] text-lg font-semibold tracking-[-0.02em] lg:mt-7"
        theme="primary"
        spread={5}
        to="#partners-apply"
        isAnimated
