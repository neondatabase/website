...
const Oauth = () => (
  <div className="oauth mt-[104px] grid w-full grid-cols-10 items-center gap-x-10 xl:mt-24 xl:gap-x-6 lg:mt-8 lg:gap-y-7 md:mt-6 md:gap-y-6">
    <div className="col-span-5 lg:col-span-full">
      ...
      <p className="mt-2.5 max-w-[590px] text-lg font-light leading-snug xl:mt-4 xl:text-base lg:mx-auto lg:max-w-[584px] lg:text-center md:mt-2">
