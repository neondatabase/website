...
const Integration = () => (
  <section className="integration safe-paddings mt-[200px] xl:mt-36 lg:mt-28">
    <Container className="grid-gap-x grid grid-cols-12" size="lg">
      <div className="col-span-10 col-start-2 flex flex-col items-center xl:col-span-full xl:col-start-1">
        ...
        <h2 className="mt-2 max-w-[600px] text-center text-[56px] font-medium leading-none tracking-tighter xl:text-[44px] lg:max-w-[450px] lg:text-4xl">
