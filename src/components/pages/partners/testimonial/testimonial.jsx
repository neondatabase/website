...
const Testimonial = () => (
  <figure className="testimonial safe-paddings mt-[200px] xl:mt-[120px]">
    <Container className="flex flex-col items-center text-center" size="xs">
      <img
        className="h-20 h-[72px] w-20 xl:w-[72px] lg:h-16 lg:w-16"
        src={quoteIcon}
        width={80}
        height={80}
        alt=""
      ...
      <figcaption className="mt-5 text-lg leading-tight tracking-[-0.02em] text-gray-new-70 lg:mt-4 lg:text-base">
