...
const FaqCard = ({ title, subtitle, createdAt, slug }) => {
        ...
        <div className="flex flex-col gap-y-[18px] sm:gap-y-4">
          <div className="max-w-[832px]">
            ...
            <div className="mt-3 flex items-center gap-2 sm:mt-2.5">
              <time
                className="relative block shrink-0 text-[15px] leading-none font-light tracking-extra-tight text-gray-new-50 uppercase dark:text-gray-new-70 md:text-sm"
                dateTime={createdAt}
              >
                {formattedDate}
              </time>
