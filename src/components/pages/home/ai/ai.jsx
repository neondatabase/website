    ...
    >
      <div className="min-w-0">
        ...
        <div className="relative mt-[182px] pl-32 sm:mt-11 md:mx-0 lg:-mx-8 lg:mt-[143px] lg:px-0 xl:mt-[174px] xl:-mr-8 xl:pl-16">
          ...
          <div className="mt-px flex items-center justify-between gap-x-4 bg-gray-new-10 px-4 py-3.5 outline outline-1 outline-gray-new-30 sm:flex-col sm:items-start sm:gap-y-4 sm:px-4 sm:py-4 lg:px-3.5 lg:py-4">
            <p className="sm::text-[15px] ml-3 text-[20px] leading-snug tracking-tight text-white sm:ml-0 lg:text-[18px]">
