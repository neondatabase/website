...
const Navigation = ({ codeSnippets, highlightedCodeSnippets }) => {
  ...
  return (
    <>
      ...
      <div className="h-[443px] lg:h-[403px]">
            ...
            {highlightedCodeSnippets.map(
              (code, index) =>
                index === activeTab && (
                  ...
                  >
                    <CodeBlockWrapper className="show-linenumbers highlighted-code h-[443px] overflow-auto lg:h-[403px] [&_[data-line]]:px-3 [&_[data-line]]:text-xs [&_[data-line]]:leading-[1.21] lg:[&_[data-line]]:text-[11px] lg:[&_[data-line]]:leading-[1.09] [&_pre]:pt-3 [&_pre_code>.line::before]:mr-7">
                      {parse(code)}
                    </CodeBlockWrapper>
                  </m.div>
                )
