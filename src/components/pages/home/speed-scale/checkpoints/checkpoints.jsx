...
const Checkpoints = () => (
  <div className="mt-60 flex flex-col gap-14 lg:mt-36 xl:mt-[184px] md:mt-[104px] md:gap-[52px]">
    <Container size="832" className="flex justify-center">
      <Heading className="text-center text-balance lg:max-w-xl lg:text-pretty xl:max-w-[640px] md:text-left">
