  ...
  <section className="mt-48 safe-paddings 3xl:mt-44 2xl:mt-40">
    <Container className="flex items-center justify-between">
      <StaticImage
        ...
        aria-hidden
      />
      <div className="max-w-[600px] mr-[110px] 3xl:max-w-[504px] 3xl:mr-[86px] 2xl:max-w-[416px] 2xl:mr-[72px]">
        ...
        <Link className="mt-6 2xl:mt-5" to="/" size="md" theme="black-secondary-5">
