...
const BackedBy = () => (
  <section
    id="backed-by-giants"
    className="backed-by relative overflow-hidden bg-[#E4F1EB] pt-40 safe-paddings pb-[168px] text-black-pure lg:py-[88px] xl:py-[136px] md:py-14"
  >
    <Container className="z-10" size="1344">
      <div className="relative z-10 flex gap-16 sm:flex-col sm:gap-20 lg:gap-8 xl:gap-[108px] md:gap-5 md:p-0">
        <div className="flex-1 border-l border-gray-new-50 px-8 sm:border-none sm:pl-0 lg:pl-[18px] xl:pr-0 xl:pl-6">
          ...
          <h2
            className={clsx(
              ...
              'lg:text-2xl xl:text-[36px] md:text-xl',
          ...
          <ul className="mt-[216px] flex gap-[92px] sm:mt-9 lg:gap-8 xl:mt-[136px] xl:gap-16 md:gap-5 xs:flex-col xs:gap-7">
            {ITEMS.map(({ icon, title, description, className }) => (
              <li className={clsx(className, 'sm:w-[220px] lg:w-40')} key={title}>
                <Image
                  className="mb-5 sm:size-5 lg:mb-3.5 lg:size-7 xl:mb-4 md:size-6"
                  src={icon}
                  width={32}
                  height={32}
                  alt=""
                />
                <h3 className="text-4xl leading-dense tracking-tighter lg:text-[28px] xl:text-[36px] md:text-[24px]">
                  {title}
                </h3>
