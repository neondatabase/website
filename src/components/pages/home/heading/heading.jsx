...
import authIcon from 'icons/home/auth.svg';
import autoscalingIcon from 'icons/home/autoscaling.svg';
...
const Heading = ({ className = '', theme = 'dark', icon, title }) => (
  ...
  >
    {icon && (
      <Image
        className="pointer-events-none md:size-9 lg:size-10 xl:size-12"
        src={ICONS[icon]}
        width={56}
        height={56}
        alt=""
    ...
    <h2
      className={clsx(
        ...
        'md:indent-0 md:text-[24px] lg:indent-16 lg:text-[28px] lg:text-wrap xl:text-[40px]',
