      ...
      <Container className="z-10" size="md">
        <div className="max-w-[600px] xl:max-w-[400px] lg:max-w-none">
          ...
          <p className="t-xl mt-8 3xl:max-w-[504px] 2xl:mt-7 2xl:max-w-[416px] xl:mt-6 lg:max-w-none">
            Neon allows to instantly branch your PostgreSQL database to support a modern
            developement workflow. Create a branch for your dev and test environments for every code
            deployment in your CI/CD pipeline. Branches are free so that you can branch for every
            code deployment in your CI/CD pipelines.
          </p>
