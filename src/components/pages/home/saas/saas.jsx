...
const SaaS = () => (
  <section className="py-48 bg-black safe-paddings 3xl:py-44 2xl:py-40 xl:py-32">
    <Container className="flex items-center justify-between">
      <div>
        <Heading tag="h2" size="lg" theme="white">
          Perfect for SaaS
        </Heading>
        <p className="max-w-[600px] t-2xl mt-5 text-white 2xl:max-w-[488px] 2xl:mt-4 xl:max-w-[400px]">
      ...
      <img
        className="3xl:max-w-[716px] 2xl:max-w-[592px] xl:max-w-[500px]"
        src={illustration}
        alt=""
        loading="lazy"
        aria-hidden
