...
const Hero = () => (
  <section className="bg-black pt-11 safe-paddings 3xl:pt-3">
    <Container className="flex items-center justify-between">
      <div className="max-w-[860px] 3xl:max-w-[750px] 2xl:max-w-[610px] xl:max-w-[535px]">
      ...
      <StaticImage
        className="max-w-[820px] -mr-5 -mb-7 3xl:max-w-[675px] 3xl:-mr-4 2xl:max-w-[565px] 2xl:-mb-5 xl:max-w-[490px] xl:mr-[-130px]"
