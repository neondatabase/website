...
const Logos = () => (
  <section className="safe-paddings mt-[176px] xl:mt-24 lg:mt-20 sm:mt-24">
    <Container
      ...
      size="1100"
    >
      <h2 className="max-w-[400px] text-[36px] font-medium leading-dense tracking-extra-tight text-white xl:text-[32px] lg:max-w-xs lg:text-[26px] md:w-full md:max-w-full md:text-center sm:text-[22px]">
