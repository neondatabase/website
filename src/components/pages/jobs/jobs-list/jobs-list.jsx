...
const JobsList = () => {
  ...
  useEffect(() => {
    fetch(`https://boards-api.greenhouse.io/v1/boards/zenithlabs/jobs?content=true`)
                ...
                {items.map(({ name, location, url }, index) => (
                  ...
                  >
                    <Link
                      ...
                      target="_blank"
                    >
                      <span className="t-xl font-semibold !leading-snug transition-colors duration-200 group-hover:text-primary-1">
                        {name}
                      </span>
