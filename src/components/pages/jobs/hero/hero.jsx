  ...
  <section className="safe-paddings bg-black pt-40 text-white xl:pt-36 lg:pt-12 md:pt-6">
    <Container size="md">
      ...
      <p className="t-lg mx-auto mt-8 max-w-[860px] text-center !leading-normal 2xl:mt-7 xl:mt-6">
        ...
        System Engineering are among our company values. Become part of a team with deep knowledge
        of Postgres internals and decades of experience building databases.
      </p>
