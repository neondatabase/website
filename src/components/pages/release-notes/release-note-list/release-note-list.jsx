...
const ReleaseNoteList = ({ items }) => (
  <div className="relative space-y-12 before:absolute before:top-4 before:bottom-3 before:left-[180px] before:h-auto before:w-px before:bg-gray-3 xl:before:hidden sm:space-y-16">
