...
const DocsHeader = ({ customType, docPageType, basePath, navigation, isClient }) => (
  <div className="flex h-28 w-full items-center after:absolute after:top-16 after:right-0 after:left-0 after:h-px after:bg-gray-new-90 dark:after:bg-gray-new-20 lg:h-14 lg:after:hidden">
