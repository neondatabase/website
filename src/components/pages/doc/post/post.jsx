...
const Post = ({
  ...
  <>
    <div
      className={clsx(
        ...
        isFlowPage
          ...
          : 'col-span-7 col-start-3 -ml-6 max-w-[832px] 3xl:col-span-8 3xl:col-start-2 3xl:ml-0 lg:max-w-none'
      )}
    >
    ...
    <div className="col-span-2 col-start-11 -ml-12 h-full max-w-64 3xl:col-start-11 3xl:-ml-20 2xl:col-span-4 2xl:col-start-9 2xl:ml-0 xl:hidden">
