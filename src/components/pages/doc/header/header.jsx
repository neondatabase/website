...
const DocsHeader = ({ customType, docPageType, isClient }) => (
  <div className="flex h-28 w-full items-center border-b border-gray-new-80 dark:border-gray-new-15">
    <Container
    ...
    >
      ...
      <div className="absolute left-1/2 flex -translate-x-1/2 gap-2.5 xl:relative xl:left-0 xl:translate-x-0">
      ...
      <div className="col-span-2 col-start-10 -ml-12 h-full 3xl:-ml-20 2xl:col-span-5 2xl:col-start-8 2xl:ml-0 2xl:flex 2xl:justify-end xl:ml-auto lg:hidden">
        <Sidebar isClient={isClient} simpleMode />
      </div>
    </Container>
  </div>
);
