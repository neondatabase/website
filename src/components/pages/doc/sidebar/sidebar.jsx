...
const Sidebar = ({ className = null, sidebar }) => (
  ...
  >
    <div className="sticky top-10 z-30 h-[calc(100vh-108px)] after:pointer-events-none after:absolute after:-bottom-10 after:z-20 after:h-28 after:w-full after:bg-gradient-to-b after:from-transparent after:to-gray-new-98 dark:after:to-gray-new-10">
