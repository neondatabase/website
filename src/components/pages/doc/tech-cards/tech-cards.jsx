        ...
        <li className="m-0! before:hidden">
          <NextLink
            className={clsx(
              ...
              'xl:p-5 dark:border-gray-new-15 dark:before:bg-[linear-gradient(275.74deg,rgba(36,38,40,0.8)_0%,rgba(36,38,40,0)_100%)] dark:hover:border-gray-new-30'
            )}
            key={index}
            href={href}
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="mt-[18px] text-xl leading-tight font-semibold text-black-new dark:text-white">
                {title}
              </h3>
