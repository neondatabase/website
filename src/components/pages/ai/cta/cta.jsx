...
const CTA = () => (
  <section className="safe-paddings mt-[200px] overflow-hidden bg-black-new 2xl:mt-40 xl:mt-[125px] lg:mt-16">
    <Container size="medium" className="grid grid-cols-12 gap-x-10 xl:gap-x-6 lg:gap-x-4">
      <div className="relative z-10 col-span-4 col-start-2 flex flex-col pb-[164px] pt-12 2xl:col-span-5 2xl:col-start-2 2xl:pb-36 xl:pb-[78px] xl:pt-20 lg:col-span-6 lg:pb-[54px]">
        ...
        <div className="mt-9 flex items-center gap-x-8 xl:mt-7 lg:gap-x-4">
          <AnimatedButton
            className="inline-flex px-14 py-5 text-lg tracking-extra-tight hover:bg-[#00FFAA] xl:px-10 xl:py-[17px] lg:px-9 lg:text-base"
            theme="primary"
      ...
      <div className="relative col-span-7 col-start-6 2xl:col-span-6 2xl:col-start-7">
        <Image
          className="absolute bottom-0 left-0 w-[842px] max-w-none 2xl:w-[750px] xl:-left-20 xl:w-[652px] lg:-left-28 lg:w-[553px]"
          src={illustration}
          width={842}
          height={482}
          alt=""
