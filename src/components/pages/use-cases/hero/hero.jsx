...
const Hero = () => (
  <section className="hero relative mt-40 safe-paddings xl:mt-[144px] lg:mt-20 md:mt-12">
    <Container size="960">
      ...
      <p className="mt-6 max-w-[672px] text-lg leading-normal tracking-extra-tight text-gray-new-60 xl:mt-5 lg:mt-[18px] lg:max-w-[581px] lg:text-base md:mt-4 md:max-w-full md:text-[0.9375rem] md:leading-snug">
        Explore the workflows teams build on Neon, from full-stack apps and branching to agents and
