  ...
  <section className="intro safe-paddings pt-[200px] xl:pt-[136px] lg:pt-28 md:pt-[88px]">
    <Container className="w-full max-w-[1344px]" size="1280">
      <div className="grid grid-cols-[768fr_534fr] gap-x-8 xl:grid-cols-[656fr_534fr] lg:grid-cols-[656fr_494fr] md:gap-y-20">
        <div className="flex min-h-[422px] flex-col border-l border-gray-new-20 pl-8 xl:min-h-[416px] lg:min-h-[406px] lg:pl-4 md:col-span-full md:min-h-fit md:border-l-0 md:pl-0">
          ...
          <p className="mt-auto max-w-[448px] text-[20px] tracking-tight text-gray-new-70 xl:max-w-[416px] xl:text-[18px] lg:max-w-[336px] lg:text-base md:mt-6 md:max-w-none md:text-[15px]">
