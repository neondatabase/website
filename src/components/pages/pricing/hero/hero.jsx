...
const items = [
  {
    ...
    features: [
      ...
      { title: '0.25 CU fixed capacity ' },
      { title: '187.5 CU-hours', tooltip: 'This is enough to run one database 24/7' },
      { title: '1 project with 10 branches' },
      { title: 'Autoscaling', disabled: true },
      {
        title: 'Configurable scale to zero',
        disabled: true,
        tooltip: 'Databases go idle after 5 minutes of inactivity',
      },
  ...
  },
  {
    ...
    features: [
      { title: '10 GiB storage', tooltip: 'Addtional storage: $3.5 for 2 GiB' },
      { title: 'Up to 4 CU capacity', tooltip: '1 CU = 1 vCPU, 4 GiB RAM' },
      { title: '300 CU-hours included', tooltip: 'Additional usage: $0.16 per CU-hour' },
      { title: '10 projects with 500 branches' },
      { title: 'Autoscaling from 0 to 4 CU' },
      { title: 'Configurable scale to zero', tooltip: 'Enable/disable' },
      { title: 'Read Replicas' },
  ...
  },
  {
    ...
    features: [
      { title: '50 GiB storage', tooltip: 'Addtional storage: $15 for 10 GiB ' },
      { title: 'Up to 8 CU capacity', tooltip: '1 CU = 1 vCPU, 4 GiB RAM' },
      { title: '750 CU-hours included', tooltip: 'Additional usage: $0.16 per CU-hour' },
      { title: '50 projects with 500 branches' },
      { title: 'Autoscaling from 0 to 8 CU' },
      { title: 'Configurable scale to zero', tooltip: 'From 1 minute to never' },
      { title: 'Read replicas' },
