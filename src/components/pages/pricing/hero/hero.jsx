...
const Hero = () => (
  <section className="relative overflow-hidden bg-black pt-44 pb-40 text-white 2xl:pt-[136px] 2xl:pb-36 lg:pt-9 lg:pb-28 md:pb-24">
    <Container className="!static text-center" size="md">
