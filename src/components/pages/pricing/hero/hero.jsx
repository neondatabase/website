      ...
      <section className="relative grow overflow-hidden bg-black pt-44 pb-40 text-white 2xl:pt-[136px] 2xl:pb-36 lg:pt-9 lg:pb-28 md:pb-24">
        <AnimatePresence mode="wait">
          {formState === FORM_STATES.SUCCESS ? (
            ...
            <m.div
              className="mx-auto max-w-[1216px] text-center xl:max-w-[936px] lg:max-w-none lg:px-8 md:px-4"
              animate={{
              ...
              <div className="mx-auto mt-16 flex 2xl:mt-12 2xl:max-w-5xl lg:mt-9 lg:max-w-[583px] lg:flex-col lg:space-y-9 md:mt-6 md:space-y-6">
                <div
                  className={clsx(
                    ...
                    'after:pointer-events-none after:absolute after:-inset-40 after:rounded-[22px] after:opacity-10 after:[filter:url("#noiseFilter")] after:[-webkit-mask-size:100%_100%] after:[mask-image:url("/images/mask.svg")] after:[-webkit-mask-repeat:no-repeat] after:[-webkit-mask-position:center_center] lg:after:hidden'
                  )}
                >
