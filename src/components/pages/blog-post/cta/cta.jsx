...
const CTA = ({ title, description, buttonText, buttonUrl }) => (
  <div className="not-prose relative my-10 after:absolute after:-inset-px after:rounded-md after:bg-[radial-gradient(circle,rgba(173,224,235,0.6)_0%,rgba(12,13,13,0.5)_120%)] after:p-px md:my-8">
    <div className="relative z-10 flex items-center justify-between overflow-hidden rounded-md bg-black-new py-6 pr-8 pl-7 sm:flex-col sm:px-6">
      <img
      ...
      <div className="sm:text-center">
        <h2 className="max-w-sm font-title text-2xl leading-none font-medium tracking-tighter text-white md:my-0 sm:leading-tight">
          {title}
        </h2>
