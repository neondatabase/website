...
const Hero = ({ title, description, date, category, className = null }) => (
  <div className={className}>
    ...
    <h1 className="post-title mt-3 text-5xl font-semibold leading-dense tracking-tighter xl:text-[44px] md:text-4xl sm:text-[32px] sm:tracking-[0.02em] xs:text-3xl">
      {title}
    </h1>
