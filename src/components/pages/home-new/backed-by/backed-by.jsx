...
const BackedBy = () => (
  <section className="backed-by safe-paddings relative overflow-hidden bg-[#E4F1EB] pb-[168px] pt-40">
    <Container className="px-0 xl:px-8" size="1344">
      ...
      <span
        className={clsx(
          'pointer-events-none absolute right-0 top-0 aspect-[1.4] w-[1360px] -translate-y-1/2 translate-x-1/2 -rotate-45 rounded-[100%] lg:hidden',
          'bg-[url("/images/pages/home-new/noise-light.png")] bg-[length:380px] [mask-image:radial-gradient(50%_50%_at_50%_50%,white,transparent)]'
        )}
        aria-hidden
      />
    </Container>
