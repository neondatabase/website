...
const { configuration } = objectStoragePageContent;
...
const Configuration = async () => {
  ...
  return (
    <section
      className="configuration pt-30 safe-paddings pb-40 text-white xl:pt-16 xl:pb-32 lg:pt-12 lg:pb-24 md:pt-10 md:pb-20"
      aria-labelledby="object-storage-configuration-heading"
      data-figma-node-id="2070:6690"
    >
      <Container size="1344">
        ...
        <h2
          ...
          id="object-storage-configuration-heading"
        >
          {configuration.title}
        </h2>
