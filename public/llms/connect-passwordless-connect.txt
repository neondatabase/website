...
> The "Passwordless auth" documentation details the process for Neon users to connect to databases using passwordless authentication methods, enhancing security by utilizing alternative authentication mechanisms such as OAuth or other token-based systems.

## Source

- [Passwordless auth HTML](https://neon.com/docs/connect/passwordless-connect): The original HTML version of this documentation
