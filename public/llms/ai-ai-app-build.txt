...
> The "app.build" documentation outlines the process for building AI applications using Neon's platform, detailing steps for setting up the environment, integrating AI models, and deploying applications efficiently.

## Source

- [app.build HTML](https://neon.com/docs/ai/ai-app-build): The original HTML version of this documentation
