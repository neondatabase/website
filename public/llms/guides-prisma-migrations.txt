...
> The document outlines the process of performing schema migrations in Neon Postgres using Prisma ORM, detailing steps for setting up the environment, executing migrations, and managing database changes effectively.

## Source

- [Schema migration with Neon Postgres and Prisma ORM HTML](https://neon.com/docs/guides/prisma-migrations): The original HTML version of this documentation
...
- [Migrations with Neon and Prisma](https://github.com/neondatabase/guide-neon-prisma): Run Neon database migrations using Prisma
