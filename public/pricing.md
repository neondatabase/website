...
- **Storage size** has no hard per-branch limit on paid plans: storage is unlimited, with only a soft limit (16 TB) to help you avoid unexpected costs. If you need more than 16 TB, reach out to Neon Support. Free is capped at 0.5 GB per project.
